...
{else}
    <div id="help">
        ...
        status rule says..."assign Grace status if the membership period ended sometime within the past month." Refer to the <a href="%1" target="_blank">CiviMember Guide</a> for more info.{/ts}
