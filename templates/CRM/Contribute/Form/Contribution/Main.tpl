...
{if $form.credit_card_number}
    ...
    {if $config->paymentBillingMode & 1}
        ...
        <tr><td class="label">{$form.billing_first_name.label} {$reqMark}</td><td>{$form.billing_first_name.html}</td></tr>
        <tr><td class="label">{$form.billing_middle_name.label}</td><td>{$form.billing_middle_name.html}</td></tr>
        <tr><td class="label">{$form.billing_last_name.label} {$reqMark}</td><td>{$form.billing_last_name.html}</td></tr>
	{assign var=n value=street_address-$bltID}
        <tr><td class="label">{$form.$n.label} {$reqMark}</td><td>{$form.$n.html}</td></tr>
