        <tr> 
            ...
            <td> 
                 {$form.contribution_date_high.label}<br /> {$form.contribution_date_high.html} &nbsp;
        ...
        <tr> 
            <td> 
                <label>{ts}Contribution Amounts{/ts} 
                <br />
            ...
            <td>
                <label>{ts}Contribution Status{/ts} 
                <br />{$form.contribution_status_id.html}
            </td>
        </tr>
        <tr>
            <td>
                <label>{ts}Paid By{/ts}</label>
                <br />{$form.contribution_payment_instrument_id.html}
            </td> 
            <td>
                {$form.contribution_transaction_id.label} 
                <br />{$form.contribution_transaction_id.html}
            </td> 
        </tr>
        <tr>
            <td>
            ...
            <td>
                  ...
                  {$form.contribution_test.html}&nbsp;{$form.contribution_test.label}
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                {$form.contribution_in_honor_of.label} 
                <br />{$form.contribution_in_honor_of.html}
            </td>
            <td>
                {$form.contribution_source.label}
