...
<div class="form-item">
    ...
    <dt>&nbsp;</dt><dd class="description">{ts}Enter the goal amount for this contribution page. You can track how you are doing against your stated goal (and at some point in time, also add a baseball bat meter / thermometer graphs etc){/ts}</dd>
    ...
    <dt>&nbsp;</dt><dd class="description">{ts}A thermometer block will be displayed when the user is making a contribution{/ts}<br />
