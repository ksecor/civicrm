...
<div class="form-item">
    ...
    <table class="form-layout-compressed">  
        ...
        <tr id="amountFields"><td colspan=2>   
           <table class="form-layout-compressed">
            {if $form.is_recur}
            ...
            <tr><td colspan=2><p>{ts}Use the table below to enter up to ten fixed contribution amounts. These will be presented as a list of radio button options. Both the label and dollar amount will be displayed.{/ts}</p> </td></tr>     
              <tr><td colspan=2>  
