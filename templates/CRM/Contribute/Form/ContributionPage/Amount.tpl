...
<div class="form-item" id="map-field">
    ...
    <p>{ts}Use the table below to enter up to ten fixed contribution amounts. These will be presented as a list of radio button options. Both the label ('contribution level') and dollar amount will be displayed.{/ts}</p>
    <table id="map-field">
