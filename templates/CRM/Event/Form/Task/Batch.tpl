...
<fieldset>
<div id="help">
    {ts}Update field values for each participation as needed. Click <strong>Update Event Participations</strong> below to save all your changes. To set a field to the same value for ALL rows, enter that value for the first participation and then click the <strong>Copy icon</strong> (next to the column title).{/ts}
</div>
