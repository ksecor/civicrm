...
<div class="form-item">
    ...
    {elseif $isRequireApproval}
        <div class="bold">
            {ts}This event requires approval prior to completing registration. Please verify the information below. Then click 'Continue' to submit your registration. Once your registration is approved, you will receive an email with a link to a web page where you can complete the registration process.{/ts}
        </div>
    {else}
        <div id="help">
