...
<div class="form-item">
    ...
    <dl>
    <dt>{$form.title.label} {include file='CRM/Core/I18n/Dialog.tpl' table='civicrm_custom_group' field='title' id=$gid}</dt><dd>{$form.title.html}</dd>
    ...
    <dt>{$form.help_pre.label} {include file='CRM/Core/I18n/Dialog.tpl' table='civicrm_custom_group' field='help_pre' id=$gid}</dt><dd class="editor">{$form.help_pre.html}<br />
        <span class="description">{ts}Explanatory text displayed at the beginning of this group of fields.{/ts}</span></dd>
    <dt>{$form.help_post.label} {include file='CRM/Core/I18n/Dialog.tpl' table='civicrm_custom_group' field='help_post' id=$gid}</dt><dd class="editor">{$form.help_post.html}<br />
