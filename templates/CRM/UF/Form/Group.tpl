...
<div class="form-item">
    ...
    <dt>&nbsp;</dt><dd class="description">{ts}If enabled, a Map link is included for all contacts with geocoding data (latitude and longitude) on profile listings and detail pages{/ts}</dd>
