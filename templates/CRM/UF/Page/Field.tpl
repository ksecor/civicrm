    ...
    {if $ufField}
        ...
        {if not ($action eq 2 or $action eq 1)}
            ...
            <tr>
                ...
                <td style="vertical-align: top"><a href="{crmURL p="civicrm/admin/uf/group" q="action=preview&id=`$gid`&reset=1&field=0&context=field"}">&raquo; {ts}Preview this profile (all fields){/ts}</a></td>
            </tr>
            </table>
        {/if}
        </div>
