...
<script type="text/javascript" src="{$config->resourceBase}js/jquery.pack.js"></script>
<script type="text/javascript" src="{$config->resourceBase}js/rest.js"></script>
<script type="text/javascript" src="{$config->resourceBase}js/jquery.treeview.min.js"></script>
<style>
...
<ul id="tagtree" class="tree">
   ...
   <li id="tag_{$id}">
{if ! $node.children}<input name="tagList[{$id}]" type="checkbox" {if $tagged[$id]}checked="checked"{/if}/>{/if}
