...
<fieldset><legend>{ts}Mailing Labels{/ts}</legend>
      <table class="form-layout">
        <tr>
            ...
            <td>{$form.mailing_format.html|crmReplace:class:huge}<br />
        ...
        <tr>
            <td class="label">{$form.individual_name_format.label}</td>
            <td>{$form.individual_name_format.html}<br />
...
<fieldset><legend>{ts}Address Display{/ts}</legend>
      <table class="form-layout">
        <tr>
            ...
            <td>{$form.address_format.html|crmReplace:class:huge}<br />
