	...
	{if $action eq 8}
      <div class="messages status">
        <dl>
          ...
          <dd>    
          {ts}WARNING: Deleting this option will result in the loss of all Relationship type records which use the option. This may mean the loss of a substantial amount of data, and the action can not be undone. Do you want to continue?{/ts}
          </dd>
       </dl>
      </div>
     {else}
