...
<fieldset>
        <dl>
          ...
          <dt>{$form.mysqlPath.label}</dt><dd>{$form.mysqlPath.html}</dd>
          <dt>&nbsp</dt><dd class="description">{ts}Absolute file-system path to the directory where the mysqldump program is located.{/ts}</dd>
