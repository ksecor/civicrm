<div class="form-item">
    <fieldset><legend>{ts}Language and Currency{/ts}</legend>    
        <dl>
            ...
            <dt>&nbsp;</dt><dd class="description">{ts 1="http://civicrm.org/download"}Default language used for this installation. Installed 'translations' are listed in langageCode_countryCode format. Check the <a href='%1' target='_blank'>CiviCRM downloads page</a> for additional translations if the one you need is not listed.{/ts}</dd>
