...
{if $newVersion}
    <div class="messages status">
        ...
        <dd>
            ...
            <p>{ts 1='http://civicrm.org/' 2='http://downloads.openngo.org/civicrm/'}Read about the new version on <a href="%1">our website</a> and <a href="%2">download it here</a>.{/ts}</p>
        </dd>
      </dl>
    </div>
{/if}
