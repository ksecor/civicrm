...
{else}
    ...
    <div id="help">
        <p>{ts 1="http://wiki.civicrm.org/confluence//x/wCs" 2=$docURLTitle 3=$rulesURL}<strong>Find Duplicate Contacts</strong> searches through your existing contacts to identify 'suspected' duplicate records - using the <strong><a href='%3'>Duplicate Contact Rules</a></strong> which you've configured for your site (<a href='%1' target='_blank' title='%2'>read more...</a>){/ts}</p>
