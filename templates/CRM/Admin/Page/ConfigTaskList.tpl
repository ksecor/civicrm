...
<table class="selector">
<tr class="columnheader"><td colspan="2">{ts}Viewing and Editing Contacts{/ts}</td></tr>
<tr class="even">
...
<table class="selector">
<tr class="columnheader"><td colspan="2">{ts}Sending Emails (includes contribution receipts and event confirmations){/ts}</td></tr>
<tr class="even">
...
<table class="selector">
<tr class="columnheader"><td colspan="2">{ts}Online Contributions / Online Membership Signup / Online Event Registration{/ts}</td></tr>
<tr class="even">
...
<table class="selector">
<tr class="columnheader"><td colspan="2">{ts}Organize your contacts{/ts}</td></tr>
<tr class="even">
...
<table class="selector">
<tr class="columnheader"><td colspan="2">{ts}Customize Data, Forms and Screens{/ts}</td></tr>
<tr class="even">
