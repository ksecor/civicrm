...
<tr>
    ...
    <td>{ts}Enable CiviContribute, CiviEvent, CiviMember and/or CiviMail components.{/ts}</td>
</tr>
...
<tr>
    <td class="nowrap"><a href="{crmURL p='civicrm/admin/payment' q='reset=1'}" id="idPayments">&raquo; {ts}Payment Processor{/ts}</a></td>
