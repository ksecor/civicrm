...
<tr><td class="label">{ts}HTML Body{/ts}<br/><small><a href='{$htmlViewURL}'>{ts}View HTML Body{/ts}</a></small></td><td class="report">{$report.mailing.body_html|escape|nl2br}</td></tr>
{/if}
</table>
{/strip}
</fieldset>
