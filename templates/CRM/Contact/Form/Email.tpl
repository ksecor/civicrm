...
{* @var $width Contains the width setting for the first column in the table *} 
    ...
    <div class="form-item">
        ...
        <span class="fields">
            ...
            {* Link to add a field. *}
            <span id="location_{$index}_email_2_show" class="add-remove-link">
    ...
    {section name = innerLoop start = 2 loop = $blockCount}
       {assign var=innerIndex value=$smarty.section.innerLoop.index}
        ...
        <div id="location_{$index}_email_{$innerIndex}" class="form-item">
            <span class="labels">
            ...
            <span class="fields">
              ...
              <span id="location_{$index}_email_{$innerIndex}_hide" class="add-remove-link element-right">
              ...
              {if $innerIndex LT $blockCount}
                ...
                <span id="location_{$index}_email_{$j}_show" class="add-remove-link">
