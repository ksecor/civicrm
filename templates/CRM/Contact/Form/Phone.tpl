...
{* @var $blockCount Contains the max number of phone field sets to offer. *} 
    ...
    <div class="form-item">
        ...
        <span class="fields">
            ...
            <!-- Link to add a field.-->
            <span id="location_{$index}_phone_2_show" class="add-remove-link">
    ...
    <div id="location_{$index}_phone_{$innerIndex}" class="form-item">
        <span class="labels">
        ...
        <span class="fields">
            ...
            <span id="location_{$index}_phone_{$innerIndex}_hide" class="add-remove-link element-right">
            ...
            <span id="location_{$index}_phone_{$j}_show" class="add-remove-link">
