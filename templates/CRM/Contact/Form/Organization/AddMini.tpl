 ...
 <table width="178" width="100%" cellpadding="2" cellspacing="2" id="crm-quick-create">
	 <tr><td class="form-item">{$form.organization_name.label}</td></tr> 
	 <tr><td class="form-item">{$form.organization_name.html}</td></tr>	 
