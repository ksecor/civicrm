<fieldset><legend>{ts}Search Case{/ts}</legend>
 <table class="form-layout">  
            ...
            <tr><td class="label"> {$form.case_start_date_low.label} </td>
                ...
                {include file="CRM/common/calendar/body.tpl" dateVar=case_end_date_high startDate=startYear endDate=endYear offset=5 trigger=trigger_search_case_2}
                </td>          
            </tr>
