...
{if $context EQ 'smog'}
    <div id="help">
        ...
        {ts 1=$group.title 2=$crmURL}The current members of the
        <strong>%1</strong> group are listed below. Use the Find box below to
        search for specific members. Use the <a href="%2">Add Members...</a>
        screen if you want to add new members to this group.{/ts}
    </div>
    <div class="form-item">
...
{elseif $context EQ 'amtg'}
    <div id="help">
        {ts 1=$group.title}Use the Search form to find contacts to add to %1. Mark the
        contacts you want to add and click 'Add Contacts...' buttons.{/ts}
    </div>
{else}
    <div id="help">
