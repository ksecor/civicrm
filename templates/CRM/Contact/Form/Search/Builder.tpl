...
<div id="help">
<p>{ts 1="http://wiki.civicrm.org/confluence//x/si"}Create your search by selecting the criteria (record type and fields), and entering the values you want to search for. You can define one or many criteria as a set:
...
<p><strong>IMPORTANT: Search Builder requires you to use specific formats for your search values. Review the <a href="%1">Search Builder documentation</a> before building your first search...</strong>{/ts}</p>
