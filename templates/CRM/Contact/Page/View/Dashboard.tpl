        ...
        <table>
         ...
         {foreach from=$rows item=row}  
            <tr class="{cycle values="odd-row,even-row"} {$row.class}">
                 ...
                 <td>
                   <a href="{crmURL p='civicrm/contact/view/activity' q="activity_id=`$row.activity_type_id`&action=view&id=`$row.id`&cid=`$row.targetID`&history=0"}">{$row.subject|mb_truncate:33:"...":true}</a>
                 </td>
                 <td>
