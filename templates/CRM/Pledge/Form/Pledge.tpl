...
{if $pledgeMode}
<div id="help">
    {ts 1=$displayName 2=$pledgeMode}Use this form to submit a new pledge on behalf of %1. <strong>A %2 transaction will be submitted</strong> using the selected payment processor.{/ts}
</div><fieldset>
{else} 
