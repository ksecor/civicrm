...
<br><br>
{ts}Please note: if you need to make changes to the application after
you have submitted it, please "Submit" the application again so it can
be checked again. Thank you.{/ts} 
</p>
<p>
{$form.is_partner_share.html}&nbsp;{ts} I understand that my
...
accurate, and honestly presented. *{/ts}
</td>
</tr>
<tr>
<td colspan=2 class="grouplabel">
<p class="app-instruction">
Recommendation Waiver * [36]
<p>
I understand that federal law provides me, after enrollment, with a
right to accesss to my recommendations, and that no school or person
can require me to waive this right.
<p>
