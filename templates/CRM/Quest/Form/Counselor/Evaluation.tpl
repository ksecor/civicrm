{* Quest Counselor Recommendation: Evaluation section *}
...
<tr>
    <td class="grouplabel" width="30%">{$form.is_context.label}</td>
    <td class="fieldlabel" width="70%">{$form.is_context.html}</td>
</tr>
