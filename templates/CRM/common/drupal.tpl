...
<div class="message status" id="feedback-request">
     {ts 1='http://objectledge.org/jira/browse/CRM?report=com.atlassian.jira.plugin.system.project:roadmap-panel' 2='http://objectledge.org/confluence/display/CRM/Demo'}<p>This site is running our v1.0 beta codebase. We strongly encourage visitors to try out the full range of available functionality - all features should be working.</p>
     ...
     <p>Please add any comments on the look and feel of these pages, along with workflow issues, on the <a href="%1">CiviCRM Comments Page</a>.</p>{/ts}
</div>
