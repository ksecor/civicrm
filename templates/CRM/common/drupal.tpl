...
<div class="message status" id="feedback-request">
     <p>
     {ts 1='http://objectledge.org/jira/browse/CRM?report=com.atlassian.jira.plugin.system.project:roadmap-panel'}We are now soliciting bug reports. If you find a bug, please review the open issues in our <a href="%1" target="_blank">bug-tracking system</a>, and 'Create a New Issue' if the bug isn't already in the UNRESOLVED list.{/ts}</p>
     <p>
