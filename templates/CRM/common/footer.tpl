...
{if $lastModified}
<span class="col1">{if $external_identifier}{ts}External Identifier{/ts}:&nbsp;{$external_identifier}{/if}&nbsp; &nbsp;{ts}CiviCRM Id{/ts}:&nbsp;{$id}</span>
