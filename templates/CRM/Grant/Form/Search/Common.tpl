            ...
            <tr>
               ...
               <td colspan="2"> 
                    {$form.grant_application_received_date_high.label} {$form.grant_application_received_date_high.html}<br /> &nbsp; &nbsp; 
           ...
           <tr>
              ...
              <td colspan="2"> 
                    {$form.grant_money_transfer_date_high.label} {$form.grant_money_transfer_date_high.html}<br /> &nbsp; &nbsp; 
