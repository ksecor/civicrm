...
<fieldset>
	...
	<div class="form-item">
		<table class="form-layout-compressed">  
			...
			<tr><td class="label">&nbsp;</td><td class="description">{ts}Actual amount granted.{/ts}</td></tr>
			...
			<tr><td class="label">&nbsp;</td><td class="description">{ts}When was the grant application received?{/ts}</td></tr>
			...
			<tr><td class="label">&nbsp;</td><td class="description">{ts}Date on which the grant decision was finalized.{/ts}</td></tr>
			...
			<tr><td class="label">&nbsp;</td><td class="description">{ts}Date on which the grant money was transferred.{/ts}</td></tr>
