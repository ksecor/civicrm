...
<fieldset>
     ...
     <dl class="html-adjust">
          ...
          <dt>{$form.application_received_date.label}</dt><dd>{$form.application_received_date.html|crmDate}
          <dt>{$form.decision_date.label}</dt><dd>{$form.decision_date.html|crmDate}</dd>
          <dt>{$form.money_transfer_date.label}</dt><dd>{$form.money_transfer_date.html|crmDate}</dd>
          <dt>{$form.grant_due_date.label}</dt><dd>{$form.grant_due_date.html|crmDate}</dd>
