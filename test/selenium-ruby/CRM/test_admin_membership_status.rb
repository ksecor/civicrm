...
class TC_TestAdminMembershipStatus < Test::Unit::TestCase
  ...
  def add_membership_status
    ...
    @selenium.type "name", "Membership Status 1"
    ...
    # Submit the form 
    @page.click_and_wait "_qf_MembershipStatus_next"
    assert @selenium.is_text_present("The membership status \"Membership Status 1\" has been saved.")
  end
 
  # Edit Membership Status information
  def edit_membership_status
    assert_equal "Edit", @selenium.get_text("//div[@id='membership_status_id']/descendant::tr[td[contains(.,'Membership Status 1')]]/descendant::a[contains(.,'Edit')]")
    @page.click_and_wait "//div[@id='membership_status_id']/descendant::tr[td[contains(.,'Membership Status 1')]]/descendant::a[contains(.,'Edit')]"
  ...
  def disable_membership_status
    assert_equal "Disable", @selenium.get_text("//div[@id='membership_status_id']/descendant::tr[td[contains(.,'Membership Status 1')]]/descendant::a[contains(.,'Disable')]")
    @page.click_and_wait "//div[@id='membership_status_id']/descendant::tr[td[contains(.,'Membership Status 1')]]/descendant::a[contains(.,'Disable')]"
  ...
  def enable_membership_status
    assert_equal "Enable", @selenium.get_text("//div[@id='membership_status_id']/descendant::tr[td[contains(.,'Membership Status 1')]]/descendant::a[contains(.,'Enable')]")
    @page.click_and_wait "//div[@id='membership_status_id']/descendant::tr[td[contains(.,'Membership Status 1')]]/descendant::a[contains(.,'Enable')]"
  end
  
  # Enable Membership Status information
  def delete_membership_status
    # Clicking Delete membership status
    assert_equal "Delete", @selenium.get_text("//div[@id='membership_status_id']/descendant::tr[td[contains(.,'Membership Status 1')]]/descendant::a[contains(.,'Delete')]")
    @page.click_and_wait "//div[@id='membership_status_id']/descendant::tr[td[contains(.,'Membership Status 1')]]/descendant::a[contains(.,'Delete')]"
