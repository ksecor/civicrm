...
class testEditLocationType(PyHttpTestCase):
    ...
    def runTest(self):
        ...
        self.msg("Testing URL: %s" % self.replaceURL('''%s/admin/contact/locationType''') % drupal_path)
        url = "%s/admin/contact/locationType" % drupal_path
        params = None
        Validator.validateRequest(self, self.getMethod(), "get", url, params)
        self.get(url, params)
        self.msg("Response code: %s" % self.getResponseCode())
        ...
        params = [
            ('''action''', '''update'''),
            ('''id''', '''6'''),]
        self.msg("Testing URL: %s" % self.replaceURL('''%s/admin/contact/locationType?action=update&id=6''') % drupal_path)
        url = "%s/admin/contact/locationType" % drupal_path
        Validator.validateRequest(self, self.getMethod(), "get", url, params)
        self.get(url, params)
        self.msg("Response code: %s" % self.getResponseCode())
        ...
        self.msg("Testing URL: %s" % self.replaceURL('''%s/admin/contact/locationType?name=Office-secondary&description=secondaryOffice&_qf_LocationType_next=Save''') % drupal_path)
        url = "%s/admin/contact/locationType" % drupal_path
        Validator.validateRequest(self, self.getMethod(), "post", url, params)
        self.post(url, params)
        self.msg("Response code: %s" % self.getResponseCode())
        ...
        params = [
            ('''reset''', '''1'''),
            ('''action''', '''browse'''),]
        self.msg("Testing URL: %s" % self.replaceURL('''%s/admin/contact/locationType?reset=1&action=browse''') % drupal_path)
        url = "%s/admin/contact/locationType" % drupal_path
        Validator.validateRequest(self, self.getMethod(), "get", url, params)
        self.get(url, params)
        self.msg("Response code: %s" % self.getResponseCode())
