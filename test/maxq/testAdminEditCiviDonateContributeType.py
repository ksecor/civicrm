...
class testAdminEditCiviDonateContributeType(PyHttpTestCase):
    def setUp(self):
        global db
    ...
    def runTest(self):
        ...
        if qid :
            ...
            Validator.validateResponse(self, self.getMethod(), url, params)
            print "******************************************************************"
            print "Contribution Type \'%s\' Updated Successfully" % name
            print "******************************************************************"
        else :
            print "******************************************************************"
...
if __name__ == 'main':
    test = testAdminEditCiviDonateContributeType("testAdminEditCiviDonateContributeType")
    test.Run()
