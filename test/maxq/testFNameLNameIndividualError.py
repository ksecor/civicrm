...
class testFNameLNameIndividualError(PyHttpTestCase):
    def runTest(self):
...
if __name__ == 'main':
    test = testFNameLNameIndividualError("testFNameLNameIndividualError")
    test.Run()
