...
class testHNameHouseholdError(PyHttpTestCase):
    def runTest(self):
        ...
        params = [
            ...
            ('''location[1][phone][1][phone]''', '''4567890'''),
            ('''location[1][phone][2][phone_type]''', ''''''),
            ('''location[1][phone][2][phone]''', ''''''),
            ('''location[1][email][1][email]''', '''xyz@hf.co'''),
...
if __name__ == 'main':
    test = testHNameHouseholdError("testHNameHouseholdError")
    test.Run()
