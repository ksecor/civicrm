...
class testAddGroupFromContactInfo(PyHttpTestCase):
    def runTest(self):
        ...
        params = [
            ('''group_id''', '''2'''),
            ('''_qf_GroupContact_next''', '''Add'''),]
        self.msg("Testing URL: %s" % self.replaceURL('''%s/civicrm/contact/view/group?group_id=2&_qf_GroupContact_next=Add''') % drupal_path)
        url = "%s/civicrm/contact/view/group" % drupal_path
        Validator.validateRequest(self, self.getMethod(), "post", url, params)
        self.post(url, params)
        self.msg("Response code: %s" % self.getResponseCode())
        ...
        params = [
            ...
            ('''action''', '''delete'''),
            ('''st''', '''o'''),]
        self.msg("Testing URL: %s" % self.replaceURL('''%s/civicrm/contact/view/group?gcid=84&action=delete&st=o''') % drupal_path)
        url = "%s/civicrm/contact/view/group" % drupal_path
        Validator.validateRequest(self, self.getMethod(), "get", url, params)
        self.get(url, params)
        self.msg("Response code: %s" % self.getResponseCode())
        ...
        # self.get(url, params)
        # self.msg("Response code: %s" % self.getResponseCode())
        # self.assertEquals("Assert number 15 failed", 404, self.getResponseCode())
        # Validator.validateResponse(self, self.getMethod(), url, params)
        ...
        # self.get(url, params)
        # self.msg("Response code: %s" % self.getResponseCode())
        # self.assertEquals("Assert number 17 failed", 404, self.getResponseCode())
        # Validator.validateResponse(self, self.getMethod(), url, params)
...
if __name__ == 'main':
    test = testAddGroupFromContactInfo("testAddGroupFromContactInfo")
    test.Run()
