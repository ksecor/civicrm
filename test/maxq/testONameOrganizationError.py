...
class testONameOrganizationError(PyHttpTestCase):
    def runTest(self):
...
if __name__ == 'main':
    test = testONameOrganizationError("testONameOrganizationError")
    test.Run()
