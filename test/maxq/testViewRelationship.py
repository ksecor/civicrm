...
class testViewRelationship(PyHttpTestCase):
    def runTest(self):
        ...
        params = [
            ...
            ('''action''', '''view'''),
            ('''rtype''', '''b_a'''),]
        self.msg("Testing URL: %s" % self.replaceURL('''%s/civicrm/contact/view/rel?rid=153&action=view&rtype=b_a''') % drupal_path)
...
if __name__ == 'main':
    test = testViewRelationship("testViewRelationship")
    test.Run()
