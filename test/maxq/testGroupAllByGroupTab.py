...
class testGroupAllbyGroupTab(PyHttpTestCase):
    def runTest(self):
        ...
        #self.msg("Testing URL: %s" % self.replaceURL('''%s/modules/civicrm/css/civicrm.css''') % drupal_path)
        url = "%s/modules/civicrm/css/civicrm.css" % drupal_path
        self.msg("Testing URL: %s" % url)
        params = None
        Validator.validateRequest(self, self.getMethod(), "get", url, params)
        self.get(url, params)
        ...
        #self.msg("Testing URL: %s" % self.replaceURL('''%s/civicrm/contact/view/group?_qf_default=GroupContact:next&group_id=3&_qf_GroupContact_next=Add''') % drupal_path)
        url = "%s/civicrm/contact/view/group" % drupal_path
        self.msg("Testing URL: %s" % url)
        Validator.validateRequest(self, self.getMethod(), "post", url, params)
        self.post(url, params)
        ...
        params = [
            ...
            ('''action''', '''delete'''),
            ('''st''', '''i'''),]
        #self.msg("Testing URL: %s" % self.replaceURL('''%s/civicrm/contact/view/group?gcid=84&action=delete&st=i''') % drupal_path)
        url = "%s/civicrm/contact/view/group" % drupal_path
        self.msg("Testing URL: %s" % url)
        Validator.validateRequest(self, self.getMethod(), "get", url, params)
        self.get(url, params)
        ...
        params = [
            ...
            ('''action''', '''delete'''),
            ('''st''', '''o'''),]
        #self.msg("Testing URL: %s" % self.replaceURL('''%s/civicrm/contact/view/group?gcid=85&action=delete&st=o''') % drupal_path)
        url = "%s/civicrm/contact/view/group" % drupal_path
        self.msg("Testing URL: %s" % url)
        Validator.validateRequest(self, self.getMethod(), "get", url, params)
        self.get(url, params)
...
if __name__ == 'main':
    test = testGroupAllbyGroupTab("testGroupAllbyGroupTab")
    test.Run()
