...
class testEmailHouseholdError(PyHttpTestCase):
    def runTest(self):
        ...
        # self.msg("Testing URL: %s" % self.replaceURL('''192.168.2.9/favicon.ico'''))
        ...
        params = [
            ...
            ('''location[1][email][1][email]''', '''kurund.jalmi.yy.co'''),
...
if __name__ == 'main':
    test = testEmailHouseholdError("testEmailHouseholdError")
    test.Run()
