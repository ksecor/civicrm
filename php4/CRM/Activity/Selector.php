...
$GLOBALS['_CRM_ACTIVITY_SELECTOR']['_actionLinks'] = '';
$GLOBALS['_CRM_ACTIVITY_SELECTOR']['_columnHeaders'] = '';
$GLOBALS['_CRM_ACTIVITY_SELECTOR']['_properties'] =  array('activity_type', 'activity_summary', 'activity_date');
 ...
 *
 */
class CRM_Activity_Selector extends CRM_Core_Selector_Base {
    /**
     ...
     * @access public
     */
    function CRM_Activity_Selector($contactId) 
    {
     ...
     function &actionLinks() 
    {
        ...
        if (!isset($GLOBALS['_CRM_ACTIVITY_SELECTOR']['_actionLinks'])) {
            $GLOBALS['_CRM_ACTIVITY_SELECTOR']['_actionLinks'] = array(
        ...
        return $GLOBALS['_CRM_ACTIVITY_SELECTOR']['_actionLinks'];
    }
    ...
    function &getColumnHeaders($action = null, $output = null) 
    {
        if ($output==CRM_CORE_SELECTOR_CONTROLLER_EXPORT || $output==CRM_CORE_SELECTOR_CONTROLLER_SCREEN) {
            ...
            foreach (CRM_Activity_Selector::_getColumnHeaders() as $column ) {
            ...
            return CRM_Activity_Selector::_getColumnHeaders();
        }
    }
    ...
    function &getRows($action, $offset, $rowCount, $sort, $output = null) {
        ...
        while ($result->fetch()) {
            ...
            foreach ($GLOBALS['_CRM_ACTIVITY_SELECTOR']['_properties'] as $property) {
                $row[$property] = $result->$property;
            }

            if ( $output != CRM_CORE_SELECTOR_CONTROLLER_EXPORT && $output != CRM_CORE_SELECTOR_CONTROLLER_SCREEN ) {
                $row['checkbox'] = CRM_CORE_FORM_CB_PREFIX . $result->contact_id;
                $row['action'] = CRM_Core_Action::formLink( CRM_Activity_Selector::actionLinks(), null, array( 'id' => $result->contact_id ) );
     ...
     */
     function getMyQILL() {
        return CRM_Activity_Selector::getQILL($this->_formValues);
    }
    ...
    {
        if ( ! isset( $GLOBALS['_CRM_ACTIVITY_SELECTOR']['_columnHeaders'] ) )
        {
            $GLOBALS['_CRM_ACTIVITY_SELECTOR']['_columnHeaders'] = array(
        ...
        return $GLOBALS['_CRM_ACTIVITY_SELECTOR']['_columnHeaders'];
    }
}
?>