...
$GLOBALS['_CRM_CORE_DAO_UFFORMFIELD']['_fields'] = null;
$GLOBALS['_CRM_CORE_DAO_UFFORMFIELD']['_links'] = null;
$GLOBALS['_CRM_CORE_DAO_UFFORMFIELD']['_import'] = null;
...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Core_DAO_UFFormField extends CRM_Core_DAO {
        ...
        */
        ...
        /**
        * Is this field part of the key for matching users to contacts?
        *
        * @var boolean
        */
        var $match_key;
        ...
        */
        function &links() 
        {
            ...
            if (!($GLOBALS['_CRM_CORE_DAO_UFFORMFIELD']['_links'])) {
        ...
        */
        function &fields() 
        {
            ...
            if (!($GLOBALS['_CRM_CORE_DAO_UFFORMFIELD']['_fields'])) {
        ...
        */
        function &import($prefix = false) 
        {
            ...
            if (!($GLOBALS['_CRM_CORE_DAO_UFFORMFIELD']['_import'])) {
