...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Core_DAO_MobileProvider extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_MOBILEPROVIDER']['_links'])) {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_MOBILEPROVIDER']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_MOBILEPROVIDER']['_import'])) {
