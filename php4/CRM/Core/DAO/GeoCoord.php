...
$GLOBALS['_CRM_CORE_DAO_GEOCOORD']['_fields'] = '';
$GLOBALS['_CRM_CORE_DAO_GEOCOORD']['_links'] = '';
$GLOBALS['_CRM_CORE_DAO_GEOCOORD']['_import'] = '';
...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Core_DAO_GeoCoord extends CRM_Core_DAO {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_GEOCOORD']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_GEOCOORD']['_import'])) {
