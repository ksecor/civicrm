<?php
    ...
    *
    */
    $GLOBALS['_CRM_CORE_DAO_HISTORY']['_tableName'] =  'crm_history';
$GLOBALS['_CRM_CORE_DAO_HISTORY']['_fields'] = '';
$GLOBALS['_CRM_CORE_DAO_HISTORY']['_links'] = '';
$GLOBALS['_CRM_CORE_DAO_HISTORY']['_import'] = '';

require_once 'CRM/Core/DAO.php';
require_once 'CRM/Utils/Array.php';
require_once 'CRM/Core/DAO.php';
    require_once 'CRM/Utils/Type.php';
    class CRM_Core_DAO_History extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            ...
            if (!($GLOBALS['_CRM_CORE_DAO_HISTORY']['_links'])) {
                $GLOBALS['_CRM_CORE_DAO_HISTORY']['_links'] = array(
                    'relationship_id'=>'crm_relationship:id',
                    'group_id'=>'crm_group:id',
                );
            }
            return $GLOBALS['_CRM_CORE_DAO_HISTORY']['_links'];
        }
        /**
        ...
        */
        function &fields() 
        {
            ...
            if (!($GLOBALS['_CRM_CORE_DAO_HISTORY']['_fields'])) {
                $GLOBALS['_CRM_CORE_DAO_HISTORY']['_fields'] = array(
                    'id'=>array(
            ...
            return $GLOBALS['_CRM_CORE_DAO_HISTORY']['_fields'];
        }
        /**
        ...
        */
        ...
        {
            return $GLOBALS['_CRM_CORE_DAO_HISTORY']['_tableName'];
        }
        /**
        ...
        */
        function &import($prefix = false) 
        {
            ...
            if (!($GLOBALS['_CRM_CORE_DAO_HISTORY']['_import'])) {
                $GLOBALS['_CRM_CORE_DAO_HISTORY']['_import'] = array();
                $fields = &CRM_Core_DAO_History::fields();
                foreach($fields as $name=>$field) {
                    if (CRM_Utils_Array::value('import', $field)) {
                        if ($prefix) {
                            $GLOBALS['_CRM_CORE_DAO_HISTORY']['_import']['History.'.$name] = &$field;
                        } else {
                            $GLOBALS['_CRM_CORE_DAO_HISTORY']['_import'][$name] = &$field;
                        }
                    }
                }
            }
            return $GLOBALS['_CRM_CORE_DAO_HISTORY']['_import'];
        }
    }
?>