...
$GLOBALS['_CRM_CORE_CONTROLLER']['_template'] = '';
$GLOBALS['_CRM_CORE_CONTROLLER']['_session'] = '';
$GLOBALS['_CRM_CORE_CONTROLLER']['names'] =  array(
...
class CRM_Core_Controller extends HTML_QuickForm_Controller {
     ...
     *
     */
    function CRM_Core_Controller( $title = null, $modal = true ) {
    ...
    function reset( ) {
        $this->container( true );
        $GLOBALS['_CRM_CORE_CONTROLLER']['_session']->resetScope( $this->_name );
    }
    ...
    function set( $name, $value = null) {
        $GLOBALS['_CRM_CORE_CONTROLLER']['_session']->set( $name, $value, $this->_name );
    }
     ...
     */
    function get( $name ) {
        return $GLOBALS['_CRM_CORE_CONTROLLER']['_session']->get( $name, $this->_name );
    }
