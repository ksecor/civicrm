...
class CRM_Core_BAO_Activity extends CRM_Core_DAO_Activity {
     ...
     * class constructor
     */
    function CRM_Core_BAO_Activity( ) {
        parent::CRM_Core_DAO_Activity( );
    }
     ...
     * @static
     */
     function &getActivity($contactId, $offset=null, $rowCount=null, $sort=null)
    {
     ...
     * @static
     */
     function &getNumActivity($contactId)
    {
        $activityDAO = new CRM_Core_DAO_Activity();
        $activityDAO->entity_table = 'crm_contact';
        $activityDAO->entity_id = $contactId;
