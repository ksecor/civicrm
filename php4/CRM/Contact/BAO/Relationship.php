...
define( 'CRM_CONTACT_BAO_RELATIONSHIP_PAST',1);
define( 'CRM_CONTACT_BAO_RELATIONSHIP_DISABLED',2);
define( 'CRM_CONTACT_BAO_RELATIONSHIP_CURRENT',4);
...
class CRM_Contact_BAO_Relationship extends CRM_Contact_DAO_Relationship {
     ...
     * @static
     */
     function checkDuplicateRelationship( $relationshipTypeId, $id, $contactId = 0) 
    {
   ...
   /**
    ...
    //static function getRelationship( $contactId, $status = 0, $numRelationship = 0, $count = 0, $relationshipId = 0, &$links = null ) {
     function getRelationship( $contactId, $status = 0, $numRelationship = 0, $count = 0, $relationshipId = 0, $links = null ) {
        ...
        if ( $count ) {
            ...
            if ( $links ) {
                $mask = CRM_CORE_ACTION_VIEW | CRM_CORE_ACTION_UPDATE | CRM_CORE_ACTION_DELETE;
