...
class CRM_Contact_BAO_Contact extends CRM_Contact_DAO_Contact 
{
    ...
    function CRM_Contact_BAO_Contact()
    {
     ...
     function permissionedContact( $id, $type = 'view' ) {
        $query = ' SELECT count(DISTINCT crm_contact.id) ' . CRM_Contact_BAO_Contact::fromClause( ) .
    ...
    function searchQuery(&$fv, $offset, $rowCount, $sort, $count = false, $includeContactIds = false)
    {
        ...
        $from = CRM_Contact_BAO_Contact::fromClause( );

        $where = CRM_Contact_BAO_Contact::whereClause( $fv, $includeContactIds );
     ...
     * @static
     */
     function whereClause( &$fv, $includeContactIds = false)
    {
        $where = '';
