...
class CRM_Contact_BAO_GroupContact extends CRM_Contact_DAO_GroupContact {
     ...
     * @static
     */
     function addContactsToGroup( &$contactIds, $groupId ) {
        $date = date('Ymd');
     ...
     * @static
     */
     function removeContactsFromGroup( &$contactIds, $groupId ) {
        $date = date('Ymd');
   ...
   /**
     ...
     * $access public
     */
     function &getContactGroup( $contactId, $status = null, $numGroupContact = null, $count = false ) {
        $groupContact = new CRM_Contact_DAO_GroupContact( );
