...
class CRM_Contact_Page_Activity {
     ...
     * @static
     */
     function view($page, $activityTableId)
    {
     ...
     function browse($page)
    {
        ...
        $selector   = new CRM_Activity_Selector($page->getContactId());
     ...
     * @static
     */
     function edit($page, $mode, $activityTableId = null)
    {
     ...
     function run($page)
    {
        ...
        if ($action & CRM_CORE_ACTION_VIEW) {
            CRM_Contact_Page_Activity::view($page, $activityTableId); // view activity
        } else if ($action & (CRM_CORE_ACTION_UPDATE | CRM_CORE_ACTION_ADD)) {
            CRM_Contact_Page_Activity::edit($page, $action, $activityTableId); // add / update
