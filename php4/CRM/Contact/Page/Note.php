...
class CRM_Contact_Page_Note {
     function view( $page, $noteId ) {
        ...
        CRM_Contact_Page_Note::browse( $page );
    }
     ...
     function edit( $page, $mode, $noteId = null ) {
     ...
     function run( $page ) {
        ...
        if ( $action & CRM_CORE_ACTION_VIEW ) {
            CRM_Contact_Page_Note::view( $page, $nid );
        } else if ( $action & ( CRM_CORE_ACTION_UPDATE | CRM_CORE_ACTION_ADD ) ) {
            CRM_Contact_Page_Note::edit( $page, $action, $nid );
        } else if ( $action & CRM_CORE_ACTION_DELETE ) {
            CRM_Contact_Page_Note::delete( $nid );
        }
