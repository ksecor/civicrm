...
$GLOBALS['_CRM_CONTACT_PAGE_SAVEDSEARCH']['_links'] = '';
...
class CRM_Contact_Page_SavedSearch extends CRM_Core_Page {
    ...
    function browse()
    {
        ...
        while ($savedSearch->fetch()) {
            ...
            $row['action']       = CRM_Core_Action::formLink( CRM_Contact_Page_SavedSearch::links(), null, array( 'id' => $row['id'] ) );
            $rows[] = $row;
        }
     ...
     function &links()
    {
        ...
        if ( ! isset( $GLOBALS['_CRM_CONTACT_PAGE_SAVEDSEARCH']['_links'] ) ) 
        {
