...
$GLOBALS['_CRM_CONTACT_DAO_TAG']['_fields'] = null;
$GLOBALS['_CRM_CONTACT_DAO_TAG']['_links'] = null;
$GLOBALS['_CRM_CONTACT_DAO_TAG']['_import'] = null;
    ...
    class CRM_Contact_DAO_Tag extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            ...
            if (!($GLOBALS['_CRM_CONTACT_DAO_TAG']['_links'])) {
        ...
        */
        function &fields() 
        {
            ...
            if (!($GLOBALS['_CRM_CONTACT_DAO_TAG']['_fields'])) {
        ...
        */
        function &import($prefix = false) 
        {
            ...
            if (!($GLOBALS['_CRM_CONTACT_DAO_TAG']['_import'])) {
