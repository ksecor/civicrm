...
$GLOBALS['_CRM_CONTACT_DAO_LOCATION']['_fields'] = '';
$GLOBALS['_CRM_CONTACT_DAO_LOCATION']['_links'] = '';
$GLOBALS['_CRM_CONTACT_DAO_LOCATION']['_import'] = '';
...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Contact_DAO_Location extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_LOCATION']['_links'])) {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_LOCATION']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_LOCATION']['_import'])) {
