...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Contact_DAO_RelationshipType extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_RELATIONSHIPTYPE']['_links'])) {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_RELATIONSHIPTYPE']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_RELATIONSHIPTYPE']['_import'])) {
