...
$GLOBALS['_CRM_CONTACT_DAO_ENTITYTAG']['_fields'] = null;
$GLOBALS['_CRM_CONTACT_DAO_ENTITYTAG']['_links'] = null;
$GLOBALS['_CRM_CONTACT_DAO_ENTITYTAG']['_import'] = null;
    ...
    class CRM_Contact_DAO_EntityTag extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            ...
            if (!($GLOBALS['_CRM_CONTACT_DAO_ENTITYTAG']['_links'])) {
        ...
        */
        function &fields() 
        {
            ...
            if (!($GLOBALS['_CRM_CONTACT_DAO_ENTITYTAG']['_fields'])) {
        ...
        */
        function &import($prefix = false) 
        {
            ...
            if (!($GLOBALS['_CRM_CONTACT_DAO_ENTITYTAG']['_import'])) {
