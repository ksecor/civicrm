...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Contact_DAO_LocationType extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_LOCATIONTYPE']['_links'])) {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_LOCATIONTYPE']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_LOCATIONTYPE']['_import'])) {
