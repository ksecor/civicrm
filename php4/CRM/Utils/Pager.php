...
class CRM_Utils_Pager extends Pager_Sliding {
    ...
    function CRM_Utils_Pager( $params ) {
         ...
         *
         */
        $this->_response['titleTop']    = 'Page <input size=2 maxlength=3 name="' . CRM_UTILS_PAGER_PAGE_ID. '" type="text" value="' . $this->_response['currentPage'] . '" /> of ' . $this->_response['numPages'];
        $this->_response['titleBottom']    = 'Page <input size=2 maxlength=3 name="' . CRM_UTILS_PAGER_PAGE_ID_BOTTOM. '" type="text" value="' . $this->_response['currentPage'] . '" /> of ' . $this->_response['numPages'];
