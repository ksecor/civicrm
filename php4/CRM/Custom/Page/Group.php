...
$GLOBALS['_CRM_CUSTOM_PAGE_GROUP']['_actionLinks'] = null;
...
class CRM_Custom_Page_Group extends CRM_Core_Page {
    ...
    function browse($action=null)
    {
        ...
        while ($customGroupBAO->fetch()) {
            ...
            $customGroup[$customGroupBAO->id]['action'] = CRM_Core_Action::formLink(CRM_Custom_Page_Group::actionLinks(), $action, 
