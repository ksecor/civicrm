 ...
 * $Id: Field.php 1207 2005-05-29 23:19:16Z dgg $
 *
 */

$GLOBALS['_CRM_CUSTOM_FORM_FIELD']['_dataTypeValues'] = '';
$GLOBALS['_CRM_CUSTOM_FORM_FIELD']['_dataTypeKeys'] = '';
...
class CRM_Custom_Form_Field extends CRM_Core_Form {
    ...
    function setDefaultValues()
    {
        ...
        if (isset($this->_id)) {
            ...
            if ( CRM_Utils_Array::value( 'data_type', $defaults ) ) {
                $defaults['data_type'] = array( '0' => array_search( $defaults['data_type'], $GLOBALS['_CRM_CUSTOM_FORM_FIELD']['_dataTypeKeys'] ),
                                                '1' => 0 );
            }
        } else {
     ...
     function buildQuickForm()
    {
        ...
        $dataHTMLElement->setOptions(array( $GLOBALS['_CRM_CUSTOM_FORM_FIELD']['_dataTypeValues'], $GLOBALS['_CRM_CUSTOM_FORM_FIELD']['_dataToHTML']));
