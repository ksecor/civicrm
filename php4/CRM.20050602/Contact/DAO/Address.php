...
$GLOBALS['_CRM_CONTACT_DAO_ADDRESS']['_fields'] = '';
$GLOBALS['_CRM_CONTACT_DAO_ADDRESS']['_links'] = '';
$GLOBALS['_CRM_CONTACT_DAO_ADDRESS']['_import'] = '';
...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Contact_DAO_Address extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_ADDRESS']['_links'])) {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_ADDRESS']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_ADDRESS']['_import'])) {
