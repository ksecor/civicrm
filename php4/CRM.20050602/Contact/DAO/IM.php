...
$GLOBALS['_CRM_CONTACT_DAO_IM']['_fields'] = '';
$GLOBALS['_CRM_CONTACT_DAO_IM']['_links'] = '';
$GLOBALS['_CRM_CONTACT_DAO_IM']['_import'] = '';
...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Contact_DAO_IM extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_IM']['_links'])) {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_IM']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_IM']['_import'])) {
