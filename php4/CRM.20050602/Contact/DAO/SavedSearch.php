...
$GLOBALS['_CRM_CONTACT_DAO_SAVEDSEARCH']['_fields'] = '';
$GLOBALS['_CRM_CONTACT_DAO_SAVEDSEARCH']['_links'] = '';
$GLOBALS['_CRM_CONTACT_DAO_SAVEDSEARCH']['_import'] = '';
...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Contact_DAO_SavedSearch extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_SAVEDSEARCH']['_links'])) {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_SAVEDSEARCH']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CONTACT_DAO_SAVEDSEARCH']['_import'])) {
