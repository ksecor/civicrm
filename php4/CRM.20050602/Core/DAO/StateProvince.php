<?php
    ...
    *
    */
    $GLOBALS['_CRM_CORE_DAO_STATEPROVINCE']['_tableName'] =  'crm_state_province';
$GLOBALS['_CRM_CORE_DAO_STATEPROVINCE']['_fields'] = '';
$GLOBALS['_CRM_CORE_DAO_STATEPROVINCE']['_links'] = '';
$GLOBALS['_CRM_CORE_DAO_STATEPROVINCE']['_import'] = '';
...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Core_DAO_StateProvince extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_STATEPROVINCE']['_links'])) {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_STATEPROVINCE']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_STATEPROVINCE']['_import'])) {
                $GLOBALS['_CRM_CORE_DAO_STATEPROVINCE']['_import'] = array();
                $fields = &CRM_Core_DAO_StateProvince::fields();
                foreach($fields as $name=>$field) {
                    if (CRM_Utils_Array::value('import', $field)) {
                        if ($prefix) {
                            $GLOBALS['_CRM_CORE_DAO_STATEPROVINCE']['_import']['StateProvince.'.$name] = &$field;
                        } else {
                            $GLOBALS['_CRM_CORE_DAO_STATEPROVINCE']['_import'][$name] = &$field;
                        }
                    }
                }
            }
