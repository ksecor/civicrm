<?php
    ...
    *
    */
    $GLOBALS['_CRM_CORE_DAO_ACTIVITY']['_tableName'] =  'crm_activity';
$GLOBALS['_CRM_CORE_DAO_ACTIVITY']['_fields'] = '';
$GLOBALS['_CRM_CORE_DAO_ACTIVITY']['_links'] = '';
$GLOBALS['_CRM_CORE_DAO_ACTIVITY']['_import'] = '';
...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Core_DAO_Activity extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_ACTIVITY']['_links'])) {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_ACTIVITY']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_ACTIVITY']['_import'])) {
                $GLOBALS['_CRM_CORE_DAO_ACTIVITY']['_import'] = array();
                $fields = &CRM_Core_DAO_Activity::fields();
                foreach($fields as $name=>$field) {
                    if (CRM_Utils_Array::value('import', $field)) {
                        if ($prefix) {
                            $GLOBALS['_CRM_CORE_DAO_ACTIVITY']['_import']['Activity.'.$name] = &$field;
                        } else {
                            $GLOBALS['_CRM_CORE_DAO_ACTIVITY']['_import'][$name] = &$field;
                        }
                    }
                }
            }
