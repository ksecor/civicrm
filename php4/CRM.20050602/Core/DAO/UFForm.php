...
$GLOBALS['_CRM_CORE_DAO_UFFORM']['_fields'] = '';
$GLOBALS['_CRM_CORE_DAO_UFFORM']['_links'] = '';
$GLOBALS['_CRM_CORE_DAO_UFFORM']['_import'] = '';
...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Core_DAO_UFForm extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_UFFORM']['_links'])) {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_UFFORM']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_UFFORM']['_import'])) {
