...
$GLOBALS['_CRM_CORE_DAO_COUNTRY']['_fields'] = '';
$GLOBALS['_CRM_CORE_DAO_COUNTRY']['_links'] = '';
$GLOBALS['_CRM_CORE_DAO_COUNTRY']['_import'] = '';
...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Core_DAO_Country extends CRM_Core_DAO {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_COUNTRY']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_COUNTRY']['_import'])) {
