...
$GLOBALS['_CRM_CORE_DAO_NOTE']['_fields'] = '';
$GLOBALS['_CRM_CORE_DAO_NOTE']['_links'] = '';
$GLOBALS['_CRM_CORE_DAO_NOTE']['_import'] = '';
...
require_once 'CRM/Core/DAO.php';
    ...
    class CRM_Core_DAO_Note extends CRM_Core_DAO {
        ...
        */
        function &links() 
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_NOTE']['_links'])) {
        ...
        */
        function &fields() 
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_NOTE']['_fields'])) {
        ...
        */
        ...
        {
            if (!isset($GLOBALS['_CRM_CORE_DAO_NOTE']['_import'])) {
