...
$GLOBALS['_CRM_CORE_FORM_RENDERER']['_sizeMapper'] =  array(
                                2  => 'two',
                                4  => 'four',
                                8  => 'eight',
                                12 => 'twelve',
    ...
    function updateAttributes(&$element, $required, $error) {
        ...
        if ( empty( $class ) ) {
            ...
            if ( $type == 'text' ) {
                ...
                if (! empty( $size ) ) {
                    if ( array_key_exists( $size, $GLOBALS['_CRM_CORE_FORM_RENDERER']['_sizeMapper'] ) ) {
                        $class = $class . ' ' . $GLOBALS['_CRM_CORE_FORM_RENDERER']['_sizeMapper'][$size];
                    }
                }
            }
        }
