 ...
 */
function crm_mailer_event_reply($job_id, $queue_id, $hash, $bodyTxt, $bodyHTML, $replyto) {
    ...
    CRM_Mailing_Event_BAO_Reply::send($queue_id, $mailing, $bodyTxt, $bodyHTML, $replyto);
