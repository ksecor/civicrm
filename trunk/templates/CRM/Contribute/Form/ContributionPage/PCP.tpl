...
<div id="form" class="form-item">
	...
	<table class="form-layout-compressed">
		<tr>
			...
			<td class="font-size11pt">{$form.is_active.html}&nbsp;{$form.is_active.label}</td>
		</tr>
	</table>
	...
	<table class="form-layout-compressed">
		<tr>
			...
			<td>{$form.is_approval_needed.html} <br />
			<span class="description">Administrator approval required for new Personal Campaign Pages.</span></td>
		</tr>
		<tr>
			<td class="label">{$form.supporter_profile_id.label}
		...
		<tr>
			...
			<td>{$form.tellfriend_limit.html}</td>
		</tr>
		<tr>
			<td class="label">{$form.link_text.label}</td>
			<td>{$form.link_text.html}</td>
		</tr>
	</table>
	</div>
