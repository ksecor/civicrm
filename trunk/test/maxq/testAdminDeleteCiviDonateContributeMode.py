...
class testAdminDeleteCiviDonateContributeMode(PyHttpTestCase):
    def setUp(self):
        global db
    ...
    def runTest(self):
        ...
        if qid :
            ...
            params = [
                ...
                ('''_qf_ContributionMode_next''', '''Delete'''),]
            url = "%s/civicrm/contribute/admin/contributionMode" % drupal_path
            self.msg("Testing URL: %s" % url)
            ...
            Validator.validateResponse(self, self.getMethod(), url, params)
            print "******************************************************************"
            print "Contribution Mode \'%s\' Deleted Successfully." % name
            print "******************************************************************"
        else :
            print "******************************************************************"
...
if __name__ == 'main':
    test = testAdminDeleteCiviDonateContributeMode("testAdminDeleteCiviDonateContributeMode")
    test.Run()
