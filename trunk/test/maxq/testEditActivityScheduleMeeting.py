...
class testEditActivityScheduleMeeting(PyHttpTestCase):
    def setUp(self):
        global db
        ...
        if cid :
            ...
            if qid :
                ...
                params = [
                    ...
                    ('''scheduled_date_time[i]''', '''0'''),
                    ('''scheduled_date_time[A]''', '''PM'''),
                    ('''duration_hours''', '''1'''),
                    ('''duration_minutes''', '''15'''),
                    ('''status''', '''Scheduled'''),
                    ('''details''', '''Test meeting Tested for Editing '''),
...
if __name__ == 'main':
    test = testEditActivityScheduleMeeting("testEditActivityScheduleMeeting")
    test.Run()
