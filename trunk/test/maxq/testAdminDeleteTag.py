...
class testAdminDeleteTag(PyHttpTestCase):
    def setUp(self):
        global db
    ...
    def runTest(self):
        ...
        name    = 'New Tag'
        queryID = 'select id from civicrm_tag where name=\'%s\'' % name
        ...
        if qid :
            ...
            Validator.validateResponse(self, self.getMethod(), url, params)
            print ("**************************************************************************************")
            print ("Tag %s Deleted Successfully" % name)
            print ("**************************************************************************************")
        else :
            print ("**************************************************************************************")
            print ("Tag %s Does not Exists" % name)
            print ("**************************************************************************************")
...
if __name__ == 'main':
    test = testAdminDeleteTag("testAdminDeleteTag")
    test.Run()
