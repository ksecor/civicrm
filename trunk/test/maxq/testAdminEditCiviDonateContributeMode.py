...
class testAdminEditCividonateContributeMode(PyHttpTestCase):
    def setUp(self):
        global db
    ...
    def runTest(self):
        ...
        if qid :
            ...
            Validator.validateResponse(self, self.getMethod(), url, params)
            print "******************************************************************"
            print "Contribution Mode \'%s\' Updated successfully." % name
            print "******************************************************************"
        else :
            print "******************************************************************"
...
if __name__ == 'main':
    test = testAdminEditCividonateContributeMode("testAdminEditCividonateContributeMode")
    test.Run()
