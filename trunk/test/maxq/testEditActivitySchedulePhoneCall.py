...
class testEditActivitySchedulePhoneCall(PyHttpTestCase):
    def setUp(self):
        global db
...
if __name__ == 'main':
    test = testEditActivitySchedulePhoneCall("testEditActivitySchedulePhoneCall")
    test.Run()
