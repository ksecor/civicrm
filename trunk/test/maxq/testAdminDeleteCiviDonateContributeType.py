...
class testAdminDeleteCiviDonateContributeType(PyHttpTestCase):
    ...
    def runTest(self):
        ...
        if qid :
            ...
            # 'new contribution changed' delete clicked
            
            params = [
                ('''_qf_default''', '''ContributionType:next'''),
                ('''_qf_ContributionType_next''', '''Delete'''),]
            url = "%s/civicrm/contribute/admin/contributionType" % drupal_path
            self.msg("Testing URL: %s" % url)
            ...
            Validator.validateResponse(self, self.getMethod(), url, params)
            print "******************************************************************"
            print "Contribution Type \'%s\' deleted successfully" % name
            print "******************************************************************"
        else :
            print "******************************************************************"
...
if __name__ == 'main':
    test = testAdminDeleteCiviDonateContributeType("testAdminDeleteCiviDonateContributeType")
    test.Run()
