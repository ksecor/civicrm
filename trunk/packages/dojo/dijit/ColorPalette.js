...
dojo.requireLocalization("dojo","colors",null,"zh-tw,pt,ROOT,zh,de,ru,hu,cs,gr,es,fr,ko,it,ja,pl");
...
var _2=dojo.moduleUrl("dojo","resources/blank.gif"),_3=new dojo.Color(),_4=this._paletteCoords;
...
for(var _f in _e){
this._connects.push(dijit.typematic.addKeyListener(this.domNode,{keyCode:dojo.keys[_f],ctrlKey:false,altKey:false,shiftKey:false},this,function(){
var _10=_e[_f];
return function(_11){
