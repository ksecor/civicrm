...
dojo.requireLocalization("dijit._editor","LinkDialog",null,"zh-tw,pt,zh,de,ru,hu,cs,gr,es,ROOT,fr,ko,it,ja,pl");
...
var _a,_b;
if(a){
_a=a.getAttribute("_djrealurl");
_b=this.tag=="img"?a.getAttribute("alt"):a.textContent||a.innerText;
dojo.withGlobal(this.editor.window,"selectElement",dijit._editor.selection,[a,true]);
}else{
_b=dojo.withGlobal(this.editor.window,dijit._editor.selection.getSelectedText);
}
if(dojo.isIE){
this._savedSelection=this.editor._getBookmark();
}
this.dropDown.reset();
this.dropDown.setValues({urlInput:_a||"",textInput:_b||""});
}});
