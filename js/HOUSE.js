	...
	{  
	   ...
	   for (k=0; k<2; k++) {
		...
		//if (document.getElementsByName('location[phone_'+String(k+2)+']').value != '') 
		  if (document.HOUSE.elements['location[phone_'+String(k+2)+']'].value != '') {
		...
		//if (document.getElementByName('location[im_screenname_'+String(k+2)+']').value != '') 
		  if (document.HOUSE.elements['location[im_screenname_'+String(k+2)+']'].value != '') {
		...
		//if (document.getElementByName('location[email'+email_name_tail[k]+']').value != '') 
		  if (document.HOUSE.elements['location[email'+email_name_tail[k]+']'].value != '') {
