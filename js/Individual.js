	...
	*/
	...
	{  
	   ...
	   /* Loop USAGE:
	      ...
	      MECHANISM:
	      The document.forms[formname] returns the CRUD form from within the forms collection of document. This reference 
      ...
      function validate_selected_locationid(formname, locid)
	   ...
	   return true;
		...
		if (locid != i && !valid_location(formname, i)) {
			...
			if (document.forms[formname].elements['location'+String(i)+'[location_type_id]'].selectedIndex == assign_index[j]) {
