function verify_page_number ( ) 
{
   ...
   if (regexp.exec(document.forms['form_body'].elements['page_no'].value) == null) {
 	alert("Please enter a valid page number");
 	er = false;
    } 

    if (parseInt(document.forms['form_body'].elements['page_no'].value) >
    ...
    if ( er == false ) {
	document.forms['form_body'].elements['page_no'].value = "";
    }
    return er;
}
