...
class CRM_Contact_Page_View_Event extends CRM_Contact_Page_View {
   ...
   */ 
  function view( ) {
    $controller =& new CRM_Core_Controller_Simple( 'CRM_Event_Form_EventView',  
						   'View Event',  
						   $this->_action ); 
    $controller->setEmbedded( true );  
  ...
  function setContext( ) {
    ...
    case 'event':
      $url = CRM_Utils_System::url( 'civicrm/contact/view',
				    "reset=1&force=1&cid={$this->_contactId}&selectedChild=event" );
      break;
