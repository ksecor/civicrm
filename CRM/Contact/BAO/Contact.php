...
";
	...
	// also add first_name, organization_name, household_name to get the respective ids in case we need them
	// we defintely need this in some form of contribution configuration0 = array( ); 
