...
class CRM_Contact_Form_Organization extends CRM_Form 
{
    ...
    function setDefaultValues( ) 
    {
        ...
        if ( $this->_mode & self::MODE_ADD ) {
            ...
            unset($params['id']);
            CRM_Contact_BAO_Organization::getValues( $params, $defaults, $ids );
    ...
    function addRules( ) 
    {
        ...
        $this->addFormRule( array( 'CRM_Contact_Form_Organization', 'formRule' ) );
    ...
    public function postProcess() 
    {
        ...
        $Organization = CRM_Contact_BAO_Organization::add( $params, $ids );
        // need to check for error here and abort / rollback if error
