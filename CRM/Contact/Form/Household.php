...
class CRM_Contact_Form_Household extends CRM_Form 
{
    ...
    function setDefaultValues( ) 
    {
        ...
        if ( $this->_mode & self::MODE_ADD ) {
            ...
            unset($params['id']);
            CRM_Contact_BAO_Household::getValues( $params, $defaults, $ids );
    ...
    function addRules( ) 
    {
        ...
        $this->addFormRule( array( 'CRM_Contact_Form_Household', 'formRule' ) );

        // rules for checking primary contact is present in the database.
        $this->addRule('primary_contact_id', t('Primary contact id is a required feild.'), 'required' );
    ...
    public function buildQuickForm( ) 
    {
        ...
        // primary_contact_id
        $this->addElement('text', 'primary_contact_id', "Primary Contact Id:", $attributes['primary_contact_id']);
    ...
    public function postProcess() 
    {
        ...
        $household = CRM_Contact_BAO_Household::add( $params, $ids );
        // need to check for error here and abort / rollback if error
