...
//             $params = array('id' =>  $this->_loadedMappingId);
//             $temp   = array ();
...
//         $this->setDefaultAction( 'refresh' );
        ...
        require_once "CRM/Core/BAO/Mapping.php";
        CRM_Core_BAO_Mapping::buildMappingForm($this, 'Export', $this->_loadedMappingId, $this->_columnCount);
