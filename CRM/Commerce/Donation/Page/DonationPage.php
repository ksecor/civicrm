...
class CRM_Commerce_Donation_Page_DonationPage extends CRM_Core_Page {
    ...
    function browse($action=null)
    {
        ...
        while ($dao->fetch()) {
            $donationPage[$dao->id] = array();
            CRM_Core_DAO::storeValues($dao, $donationPage[$dao->id]);
            ...
            $donationPage[$dao->id]['action'] = CRM_Core_Action::formLink(self::actionLinks(), $action, 
                                                                          array('id' => $dao->id));
        }
        $this->assign('rows', $donationPage);
    }
}
?>