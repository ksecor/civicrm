...
-- add table definiton and data for civicrm_contact_type table
   CREATE TABLE IF NOT EXISTS civicrm_contact_type (
     ...
     {localize field='label'}label varchar(64) collate utf8_unicode_ci default NULL COMMENT 
     'localized Name of Contact Type.'{/localize},
     {localize field='description'} description text collate utf8_unicode_ci COMMENT 'localized 
     Optional verbose description of the type.'{/localize},               
   ...
   VALUES
       ...
       (4, 'Student', {localize}'Student'{/localize}, NULL, 1, 1,0),
       (5, 'Parent', {localize}'Parent'{/localize}, NULL, 1, 1,0),
