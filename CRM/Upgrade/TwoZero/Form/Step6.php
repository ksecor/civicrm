...
class CRM_Upgrade_TwoZero_Form_Step6 extends CRM_Upgrade_Form {
    ...
    function verifyPreDBState( &$errorMessage ) {
        ...
        if (! CRM_Core_DAO::checkFKConstraintInFormat('civicrm_contribution_page', 'payment_processor_id') ||
            ...
            $errorMessage = ts('Database consistency check failed for step 6. FK constraint names not in the required format. Please rebuild your 1.9 Database to Ensure Schema Integrity.');
            return false;
        }
