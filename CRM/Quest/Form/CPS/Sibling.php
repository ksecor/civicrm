 ...
 * 
 */
class CRM_Quest_Form_CPS_Sibling extends CRM_Quest_Form_App
{
    ...
    public function buildQuickForm( ) 
    {
        ...
        $this->addFormRule(array('CRM_Quest_Form_CPS_Sibling', 'formRule'));
    ...
    public function postProcess()  
    {
        if ( ! ( $this->_action &  CRM_Core_Action::VIEW ) ) {
            ...
            if ( $buttonName == $this->_deleteButtonName ) {
                ...
                CRM_Quest_Form_CPS_Sibling::getPages( $this->controller, true );
        ...
        if ( ! $details || $reset ) {
            ...
            while ( $dao->fetch( ) ) {
                if ( $i > $totalSiblings ) {
                    ...
                    $details["Sibling-{$i}"] = array( 'className' => 'CRM_Quest_Form_CPS_Sibling',
