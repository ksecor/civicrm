 ...
 * 
 */
class CRM_Quest_Form_CPS_Household extends CRM_Quest_Form_App
{
...
//                 }
        ...
        $this->addElement('textarea',
                          'description',
                          ts( 'If this section above does not adequately capture your primary caregiver situation (e.g., perhaps your older sibling was your guardian), or if you have any other unique circumstances regarding your household situation, please provide additional information here:' ),
                          CRM_Core_DAO::getAttribute( 'CRM_Quest_DAO_Household', 'description' ) );

        $this->addFormRule(array('CRM_Quest_Form_CPS_Household', 'formRule'));
...
";
            ...
            require_once "CRM/Quest/Form/CPS/Income.php";
            CRM_Quest_Form_CPS_Income::getPages( $this->controller, true );
    ...
    static function &getPages( &$controller, $reset = false ) 
    {
        ...
        if ( ! $details || $reset ) {
            ...
            $details["Guardian-Mother"] = array( 'className' => 'CRM_Quest_Form_CPS_Guardian', 
                                                 'title' => "Mother",
            ...
            $details["Guardian-Father"] = array( 'className' => 'CRM_Quest_Form_CPS_Guardian', 
                                                 'title' => "Father",
                                                 'options' => array( 'personID'         => null,
                                                                     'relationshipID'   => $relationshipID,
            ...
            while ( $dao->fetch( ) ) {
                ...
                $details[$pageName] = array( 'className' => 'CRM_Quest_Form_CPS_Guardian', 
                                             'title' => "$name",
