 ...
 * 
 */
class CRM_Quest_Form_CPS_Recommendation extends CRM_Quest_Form_App
{
...
";
                ...
                // CRM_Core_Error::debug( 'i', $this->_oldParams );
    ...
    public function buildQuickForm( ) 
    {
        ...
        // add form rule
        $this->addFormRule(array('CRM_Quest_Form_CPS_Recommendation', 'formRule'));
