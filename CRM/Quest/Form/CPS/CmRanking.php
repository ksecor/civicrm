 ...
 * 
 */
class CRM_Quest_Form_CPS_CmRanking extends CRM_Quest_Form_App
{
     /**
    ...
    public function buildQuickForm( ) 
    {
        ...
        $ranking  = array_merge($ranking, array('Not Interested'));
        ...
        $this->addFormRule(array('CRM_Quest_Form_CPS_CmRanking', 'formRule'));
