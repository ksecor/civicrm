 ...
 * 
 */
class CRM_Quest_Form_CPS_Personal extends CRM_Quest_Form_App
{
    ...
    public function buildQuickForm( ) 
    {
        ...
        $this->add('date', 'birth_date',
                   ...
                   CRM_Core_SelectValues::date('custom', 23, 0, "M\001d\001Y" ),
                   true);        
        ...
        $this->addFormRule(array('CRM_Quest_Form_CPS_Personal', 'formRule'));
