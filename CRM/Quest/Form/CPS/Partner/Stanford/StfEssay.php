...
require_once 'CRM/Quest/Form/CPS/Essay.php';

/**
 * This class generates form components for relationship
 * 
 */
class CRM_Quest_Form_CPS_Partner_Stanford_StfEssay extends CRM_Quest_Form_CPS_Essay
{
     static $dontCare;
    /**
    ...
    public function buildQuickForm( ) 
    {
        ...
        $this->addFormRule(array('CRM_Quest_Form_CPS_Partner_Stanford_StfEssay', 'formRule'));
