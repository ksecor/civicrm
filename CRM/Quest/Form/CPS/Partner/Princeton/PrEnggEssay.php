 ...
 * 
 */
class CRM_Quest_Form_CPS_Partner_Princeton_PrEnggEssay extends CRM_Quest_Form_App
{
    ...
    public function buildQuickForm( ) 
    {
        ...
        $this->addFormRule(array('CRM_Quest_Form_CPS_Partner_Princeton_PrEnggEssay', 'formRule'), $this->_contactID);
