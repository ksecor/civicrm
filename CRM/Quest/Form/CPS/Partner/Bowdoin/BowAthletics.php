...
/**
 * This class generates form components for the bowdoin athletics supplemtn
 * 
 */
class CRM_Quest_Form_CPS_Partner_Bowdoin_BowAthletics extends CRM_Quest_Form_App
{
    ...
    public function preProcess()
    {
        ...
        $this->_essays = CRM_Quest_BAO_Essay::getFields( 'cm_partner_bowdoin_athletic', $this->_contactID, $this->_contactID );
    }
    ...
    public function buildQuickForm( ) 
    {
       $attributes = CRM_Core_DAO::getAttribute('CRM_Quest_Partner_DAO_Bowdoin');
        ...
        $this->addFormRule( array( 'CRM_Quest_Form_CPS_Partner_Bowdoin_BowAthletics',
                                   'formRule' ),
                            'Bowdoin' );
    ...
    public function postProcess() {
        ...
        require_once 'CRM/Quest/BAO/Extracurricular.php';
        CRM_Quest_BAO_Extracurricular::process( $this->_contactID, 'Bowdoin', $params );
