 ...
 * 
 */
class CRM_Quest_Form_CPS_Partner_Wellesley_WellApplicant extends CRM_Quest_Form_App
{
    ...
    public function buildQuickForm( ) 
    {
        ...
        $this->addFormRule(array('CRM_Quest_Form_CPS_Partner_Wellesley_WellApplicant', 'formRule'));
