 ...
 *
 */
class CRM_Quest_StateMachine_CPS_Preview extends CRM_Quest_StateMachine_CPS {
    ...
    public function rebuild( &$controller, $action = CRM_Core_Action::NONE ) {
        ...
        foreach ( $sections as $section ) {
            require_once "CRM/Quest/StateMachine/CPS/{$section}.php";
            eval( "CRM_Quest_StateMachine_CPS_{$section}::setPages( " . '$this->_pages, $this, $controller );' );
        }
