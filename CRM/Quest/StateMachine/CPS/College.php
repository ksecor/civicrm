 ...
 *
 */
class CRM_Quest_StateMachine_CPS_College extends CRM_Quest_StateMachine_CPS {
    ...
    static public function setPages( &$pages, &$stateMachine, &$controller ) {
        $pages['CRM_Quest_Form_CPS_CmRanking' ] = null;
        $pages['CRM_Quest_Form_CPS_ForwardApp'] = null;
    }
