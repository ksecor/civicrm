 ...
 *
 */
class CRM_Quest_StateMachine_CPS_School extends CRM_Quest_StateMachine_CPS {
    ...
    static public function setPages( &$pages, &$stateMachine, &$controller ) {
        $pages['CRM_Quest_Form_CPS_HighSchool' ] = null;
        $pages['CRM_Quest_Form_CPS_SchoolOther'] = null; 
        $pages['CRM_Quest_Form_CPS_Academic'   ] = null;
        ...
        foreach ( $grades as $grade => $title ) {
            $pages["Transcript-{$grade}"] = array( 'className' => "CRM_Quest_Form_CPS_Transcript_$grade",
                                                   'title'     => $title,
                                                   'options'   => array( ) );
        }
        
        $pages['CRM_Quest_Form_CPS_Testing'         ] = null;
        $pages['CRM_Quest_Form_CPS_RecommendationV2'] = null;
    }
