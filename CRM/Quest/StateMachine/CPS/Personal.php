 ...
 *
 */
class CRM_Quest_StateMachine_CPS_Personal extends CRM_Quest_StateMachine_CPS {
    ...
    static public function setPages( &$pages, &$stateMachine, &$controller ) {
        $pages['CRM_Quest_Form_CPS_Personal'            ] = null;
        $pages['CRM_Quest_Form_CPS_Scholarship'         ] = null;
        $pages['CRM_Quest_Form_CPS_Educational'         ] = null;
        $pages['CRM_Quest_Form_CPS_ExtracurricularInfo' ] = null;
        $pages['CRM_Quest_Form_CPS_WorkExperience'      ] = null;
    }
