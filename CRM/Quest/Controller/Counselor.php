...
class CRM_Quest_Controller_Counselor extends CRM_Core_Controller {
    ...
    function __construct( $title = null, $action = CRM_Core_Action::NONE, $modal = true ) {
        ...
        $this->_stateMachine =& new CRM_Quest_StateMachine_Counselor( $this, $this->_action );
