...
require_once 'CRM/Quest/Controller/CPS.php';

class CRM_Quest_Controller_CPS_Partner extends CRM_Quest_Controller_CPS {
    ...
    function validateCategory( ) {
        ...
        if ( ! $valid ) {
            ...
            if ( $dao->find( true ) && $dao->status_id == 328 ) {
                ...
                CRM_Utils_System::redirect( CRM_Utils_System::url( 'civicrm/quest/cps/college',
                                                                   "reset=1" ) );
            }
        }
        return true;
