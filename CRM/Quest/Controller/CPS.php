...
class CRM_Quest_Controller_CPS extends CRM_Core_Controller {
    ...
    function __construct( $title = null, $action = CRM_Core_Action::NONE, $modal = true, $subType = null ) {
        ...
        require_once "CRM/Quest/StateMachine/CPS/$subType.php";
        eval( '$this->_stateMachine =& new CRM_Quest_StateMachine_CPS_' . $subType . '( $this, $this->_action );' );
    ...
    public function &getCategory( ) {
        $session =& CRM_Core_Session::singleton( );
        $this->_categories = $session->get( 'questCPSCategory' );
        if ( ! $this->_categories ) {
            ...
            $this->_categories['steps']['Personal'] = 
                array( 'link'    => CRM_Utils_System::url( 'civicrm/quest/cps/personal',
                                                           "reset=1&$action&id={$this->_contactID}" ),
                       'title'   => 'Personal Information',
                       'current' => true,
                       'valid'   => false );
            $this->_categories['steps']['Household'] = 
                array( 'link'    => CRM_Utils_System::url( 'civicrm/quest/cps/household',
                                                           "reset=1&$action&id={$this->_contactID}" ),
                       'title'   => 'Household Information',
                       'current' => false,
                       'valid'   => false );
            $this->_categories['steps']['School'] = 
                array( 'link'    => CRM_Utils_System::url( 'civicrm/quest/cps/school',
                                                           "reset=1&$action&id={$this->_contactID}" ),
                       'title'   => 'School Information',
                       'current' => false,
                       'valid'   => false );
            $this->_categories['steps']['Essay'] = 
                array( 'link'    => CRM_Utils_System::url( 'civicrm/quest/cps/essay',
                                                           "reset=1&$action&id={$this->_contactID}" ),
                       'title'   => 'Essays',
                       'current' => false,
                       'valid'   => false );
            $this->_categories['steps']['College'] = 
                array( 'link'    => CRM_Utils_System::url( 'civicrm/quest/cps/college',
                                                           "reset=1&$action&id={$this->_contactID}" ),
                       'title'   => 'College Match',
                       'current' => false,
                       'valid'   => false );
            $this->_categories['steps']['Submit'] = 
                array( 'link'    => CRM_Utils_System::url( 'civicrm/quest/cps/submit',
                                                           "reset=1&$action&id={$this->_contactID}" ),
...
";
            ...
            $session->set( 'questCPSCategory', $this->_categories );
        }
...
//                 CRM_Utils_System::redirect( CRM_Utils_System::url( "civicrm/quest/cps/$section",
//                                                                    "reset=1&id=$cid" ) );
//             }
        }
    }
