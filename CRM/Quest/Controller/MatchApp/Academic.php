...
class CRM_Quest_Controller_MatchApp_Academic extends CRM_Quest_Controller_MatchApp {
    ...
    function __construct( $title = null, $action = CRM_Core_Action::NONE, $modal = true ) {
        parent::__construct( $title, $action, $modal, 'Academic' );
    }
    ...
    function wizardHeader( $currentPageName ) {
        $this->_sections = array(
                                 'Transcript' => array( 'title' => 'Transcript',
                                                        'processed' => true,
                                                        'valid'     => true,
                                                        'index'     => 0 ),
                                 );
