...
class CRM_Report_Form_Contribute_RepeatSummary extends CRM_Report_Form {
    ...
    function postProcess( ) {
        ...
        foreach ( $rows as $uid => $row ) {
            ...
            if ( $row['c1_total_amount_count'] ) {
                $rows[$uid]['c1_total_amount_sum'] = 
                    $row['c1_total_amount_sum'] . " ({$row['c1_total_amount_count']})";
            }
            if ( $row['c2_total_amount_count'] ) {
                $rows[$uid]['c2_total_amount_sum'] = 
                    $row['c2_total_amount_sum'] . " ({$row['c2_total_amount_count']})";
            }
        }
        ...
        unset($this->_columnHeaders['c1_total_amount_count'], 
              $this->_columnHeaders['c2_total_amount_count']);
