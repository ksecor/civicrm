...
/**
 * This class displays the CiviContribute contributions
 *
 */
class CRM_Contribute_Display
{
    ...
    static function details($id, $activityHistoryId)
    {
        ...
        if ($contributionId) {
            return CRM_Utils_System::url('civicrm/contribute/display', "reset=1&id=$contributionId");
        } else {
