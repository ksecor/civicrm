...
class CRM_Contribute_BAO_PaymentInstrument extends CRM_Contribute_DAO_PaymentInstrument 
{
     ...
     */
    static $_defaultPaymentInstrument = null;
    ...
    {
        if (self::$_defaultPaymentInstrument == null) {
            $params = array('is_default' => 1);
            $defaults = array();
            self::$_defaultPaymentInstrument = self::retrieve($params, $defaults);
        }
        return self::$_defaultPaymentInstrument;
    }
    ...
    static function del($paymentInstrumentId) 
    {
        //check dependencies
