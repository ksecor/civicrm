...
class CRM_Contacts_Form_CRUD extends CRM_Form 
{
  ...
  function buildQuickForm()
  {
    ...
    $this->add('checkbox', 'is_deceased', null, null,array('onclick' => "document.getElementById('mdy').value = 'click';"));
    ...
    $loc1[8] = & $this->createElement('text', 'email', null, array('size' => '47px','id' => 'l1em'));
    $loc1[9] = & $this->createElement('text', 'email_secondary', null, array('size' => '47px','id' => 'l1ems'));
    $loc1[10] = & $this->createElement('text', 'email_tertiary', null, array('size' => '47px','id' => 'l1emt'));
   ...
   /* Entering location cabin 2 */
    ...
    $loc2[10] = & $this->createElement('text', 'email_tertiary', null, array('size' => '47px','id' => 'l2emt'));
    ...
    $loc3[8] = & $this->createElement('text', 'email', null, array('size' => '47px','id' => 'l3em'));
    $loc3[9] = & $this->createElement('text', 'email_secondary', null, array('size' => '47px','id' => 'l3ems'));
    $loc3[10] = & $this->createElement('text', 'email_tertiary', null, array('size' => '47px','id' => 'l3emt'));
