...
class CRM_Contacts_Form_CRUD extends CRM_Form {
  ...
  function addRules( ) {
    ...
    $this->addRule( 'first_name', t(' FIRST NAME IS A REQUIRRED FIELD.'), 'required', null, 'client' );
    $this->addRule( 'last_name', t(' LAST NAME IS A REQUIRRED FIELD.'), 'required', null, 'client' );
