...
class CRM_PledgeBank_Form_Search extends CRM_Core_Form
{
    ...
    function buildQuickForm( ) 
    {
        ...
        require_once 'CRM/PledgeBank/BAO/Query.php';
        CRM_PledgeBank_BAO_Query::buildSearchForm( $this );
        ...
        if ( is_array( $rows ) ) {
            ...
            $tasks = array( '' => ts('- more actions -') ) + CRM_PledgeBank_Task::tasks( );
            if ( isset( $this->_ssID ) ) {
                require_once "CRM/Core/Permission.php";
                $permission = CRM_Core_Permission::getPermission( );
                if ( $permission == CRM_Core_Permission::EDIT ) {
                    $tasks = $tasks + CRM_CRM_PledgeBank_Task::optionalTaskTitle();
                }
