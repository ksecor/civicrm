...
require_once 'CRM/PledgeBank/Task.php';

class CRM_PledgeBank_StateMachine_Search extends CRM_Core_StateMachine
{
    /**
    ...
    function __construct( $controller, $action = CRM_Core_Action::NONE )
    {
        ...
        $this->_pages['CRM_PledgeBank_Form_Search'] = null;
        ...
        if ( $result ) {
            $this->_pages['CRM_PledgeBank_Form_Task_Result'] = null;
        }
    ...
    function taskName( $controller, $formName = 'Search' )
    {
        ...
        default: // the print task is the default and catch=all task
            $task = 'CRM_PledgeBank_Form_Task_Print';
            break;
        }
