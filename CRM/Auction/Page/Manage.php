...
class CRM_Auction_Page_Manage extends CRM_Core_Page
{
        ...
        if (!(self::$_actionLinks)) {
            ...
            self::$_actionLinks = array(
                                        CRM_Core_Action::UPDATE  => array(
                                                                          'name'  => ts('Configure'),
                                                                          'url'   => 'civicrm/admin/auction/add',
                                                                          'qs'    => 'action=update&id=%%id%%&reset=1',
                                                                          'title' => ts('Configure Auction') 
                                                                          ),
    ...
    function run()
    {
        ...
        $breadCrumb = array ( array('title' => ts('Manage Auctions'),
...
ORDER BY start_date desc
   LIMIT $offset, $rowCount";
        ...
        $dao = CRM_Core_DAO::executeQuery( $query, $params, true, 'CRM_Auction_DAO_Auction' );
    ...
    function whereClause( &$params, $sortBy = true, $force ) {
        ...
        $auctionByDates = $this->get( 'auctionByDates' );
     ...
     function pager( $whereClause, $whereParams ) {
        ...
        $params['status']       = ts('Auction %%StatusMessage%%');
