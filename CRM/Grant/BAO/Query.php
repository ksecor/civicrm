...
class CRM_Grant_BAO_Query 
{
    ...
    static function &getParticipantFields( $onlyParticipant = false ) 
    {
        ...
        $fields =& CRM_Grant_BAO_Participant::importableFields( 'Individual', true, $onlyParticipant );
        return $fields;
    }
    ...
    static function whereClauseSingle( &$values, &$query ) 
    {
        ...
        case 'event_title':
            ...
            $query->_qill[$grouping ][] = ts( 'Grant %2 %1', array( 1 => $value, 2 => $op) );
        ...
        case 'event_type':
            ...
            $query->_qill[$grouping ][] = ts( 'Grant Type - %1', array( 1 => $value ) );
            $query->_tables['civicrm_event'] = $query->_whereTables['civicrm_event'] = 1;
            return;
        ...
        case 'event_participant_role':
            ...
            require_once 'CRM/Grant/PseudoConstant.php';
            $roleTypes  = CRM_Grant_PseudoConstant::participantRole( );
    ...
    static function buildSearchForm( &$form ) 
    {
        ...
        $dataURLGrant     = CRM_Utils_System::url( 'civicrm/ajax/event',
                                                   "d={$domainID}&s=%{searchString}",
                                                   true, null, false);
        $dataURLGrantType = CRM_Utils_System::url( 'civicrm/ajax/eventType',
                                                   "d={$domainID}&s=%{searchString}",
                                                   true, null, false);
        
        $form->assign( 'dojoIncludes', "dojo.require('dojo.widget.ComboBox');" );
        
        $dojoAttributesGrant     = " dojoType='ComboBox' mode='remote' dataUrl='{$dataURLGrant}' ";
        $dojoAttributesGrantType = " dojoType='ComboBox' mode='remote' dataUrl='{$dataURLGrantType}' ";
        
        $title =& $form->add('text', 'event_title', ts('Grant Name'), $dojoAttributesGrant );
        $type  =& $form->add('text', 'event_type',  ts('Grant Type'), $dojoAttributesGrantType );
        ...
        $form->add('date', 'event_start_date_low', ts('Grant Date - From'), CRM_Core_SelectValues::date('relative')); 
        ...
        require_once 'CRM/Grant/PseudoConstant.php';
//        $statusValues = CRM_Grant_PseudoConstant::participantStatus(); 
...
//        $roleValues = CRM_Grant_PseudoConstant::participantRole();
        ...
        $form->assign( 'validCiviGrant', true );
    }
