...
class api_v2_ParticipantPaymentCreateTest extends CiviUnitTestCase 
{
    ...
    {
        return array(
                     'name'        => 'Participant Payment Create',
                     'description' => 'Test all Participant Payment Create API methods.',
