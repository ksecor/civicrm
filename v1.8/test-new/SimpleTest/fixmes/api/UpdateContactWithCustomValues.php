...
class TestOfUpdateContactWithCustomValuesAPI extends UnitTestCase 
{
    ...
    function testUpdateIndividual() 
    {
        ...
        $params = array('contact_id'    => $this->_individual->id,
                        ...
                        $customField1   => 'WOW ... it works .. Edited !!!!',
                        $customField2   => 'Option 4 Field 2 Group 1, Option 3 Field 2 Group 1'
                        );
