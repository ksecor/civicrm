if(!dojo._hasResource["dojox.highlight.languages.php"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.highlight.languages.php"] = true;
dojo.provide("dojox.highlight.languages.php"); 
//
...
(function(){
    ...
    dojo.mixin(dojox.highlight.LANGUAGES,{
        // summary: PHP highlight definitions
        php : {
            defaultMode: {
                lexems: [IDENT_RE],
