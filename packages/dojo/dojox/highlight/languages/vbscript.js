if(!dojo._hasResource["dojox.highlight.languages.vbscript"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.highlight.languages.vbscript"] = true;
