...
if(_9=="style"){
_5.push([_9,_3.style.cssText.toLowerCase()]);
}else{
_5.push([_9,_9=="class"?_3.className:_3.getAttribute(_9)]);
}
}
}
}else{
var _a,i=0,_c=_3.attributes;
while((_a=_c[i++])){
var n=_a.name;
if(n.substr(0,3)!="_dj"){
var v=_a.value;
...
i=0;
while((_a=_5[i++])){
_4+=" "+_a[0]+"=\""+dijit._editor.escapeXml(_a[1],true)+"\"";
}
