...
d.isOpera=(_b.indexOf("Opera")>=0)?tv:0;
var _e=Math.max(_c.indexOf("WebKit"),_c.indexOf("Safari"),0);
if(_e){
d.isSafari=parseFloat(_c.split("Version/")[1])||((parseFloat(_c.substr(_e+7))>=419.3)?3:2)||2;
}
d.isAIR=(_b.indexOf("AdobeAIR")>=0)?1:0;
d.isKhtml=(_c.indexOf("Konqueror")>=0||d.isSafari)?tv:0;
d.isMozilla=d.isMoz=(_b.indexOf("Gecko")>=0&&!d.isKhtml)?tv:0;
d.isFF=d.isIE=0;
if(d.isMoz){
d.isFF=parseFloat(_b.split("Firefox/")[1])||0;
}
if(document.all&&!d.isOpera){
d.isIE=parseFloat(_c.split("MSIE ")[1])||0;
}
...
var _1e=(e&&e.type)?e.type.toLowerCase():"load";
if(arguments.callee.initialized||(_1e!="domcontentloaded"&&_1e!="load")){
return;
}
...
(function(){
var _w=window;
var _20=function(_21,fp){
var _23=_w[_21]||function(){
};
_w[_21]=function(){
fp.apply(_w,arguments);
_23.apply(_w,arguments);
};
};
if(dojo.isIE){
if(!dojo.config.afterOnLoad){
...
var _24=true;
_20("onbeforeunload",function(){
_w.setTimeout(function(){
_24=false;
},0);
});
_20("onunload",function(){
if(_24){
dojo.unloaded();
}
});
...
if(mp){
for(var _26 in mp){
dojo.registerModulePath(_26,mp[_26]);
}
}
})();
