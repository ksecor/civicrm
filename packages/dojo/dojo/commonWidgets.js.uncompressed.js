...
dojo.declare(
	...
	null,
	{
		...
		//		the `<input>` field
		// CiviCRM specific changes, by default we should set this to false - kurund
		autoComplete: false,
...
if(!dojo._hasResource["civicrm.TitlePane"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
