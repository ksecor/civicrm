 ...
 * @version    CVS: $Id: IS.php,v 1.22 2006/05/16 14:58:43 bjori Exp $
...
// {{{ bool Validate_IS::postalCode(int $postCode [, bool $strong = false [, string $dataDir = DATADIR [, string $url = postur.is]]])
                        ...
                        $url = 'http://www.postur.is/gogn/Gotuskra/postnumer.txt')
    {
        ...
        $dataDir = !empty($dataDir) ? $dataDir : 'packages/data/Validate_IS';
...
// {{{ mixed Validate_IS::address(string $address [, int $postcode = null [, $dataDir = packages/data/Validate_IS/]]
    /**
    ...
    function address($address, $postcode = null, $dataDir = '')
    {
        ...
        $file = $dataDir ? $dataDir. '/IS_gotuskra.txt' : 'packages/data/Validate_IS/IS_gotuskra.txt';
