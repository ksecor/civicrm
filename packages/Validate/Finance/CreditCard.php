    ...
    function type($creditCard, $cardType)
    {
        switch (strtoupper($cardType)) {
            ...
            case 'LASER':
                ...
                break;
            case 'SOLO':
              $regex = '(6334[5-9]{1}[0-9]{1}|6767[0-9]{2}|3528[0-9]{2})([0-9]{10})';
            case 'SWITCH':  
			  $regex = '(49030[2-9]{1}|49033[5-9]{1}|49110[1-2]{1}|49117[4-9]{1}|49118[0-2]{1}|4936[0-9]{2}|564182|6333[1-4]{1}[0-9]{1}|6759[0-9]{2})([0-9]{10}|[0-9]{12}|[0-9]{13})?';
            default:
                return false;
        }
        $regex = '/^' . $regex . '$/';
