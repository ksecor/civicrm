...
CREATE TABLE contact_domain (
    ...
    uid CHAR(32) NOT NULL COMMENT 'domain id',
	...
	created_by CHAR(32) NOT NULL COMMENT 'contact uid of person creating this revision',

	PRIMARY KEY (id),
    INDEX index_uidrid(uid, rid)

    -- Must create FK after contact table is created (circular reference) 
    -- FOREIGN KEY (created_by) REFERENCES contact(uid)
...
CREATE TABLE contact_context (
	...
	domain_uid  CHAR(32) NOT NULL COMMENT 'which organization/domain owns this context',

	name        VARCHAR(255) COMMENT 'context name (typically short and brief)',
    description VARCHAR(255) COMMENT 'context description ((a more verbose description)',

	PRIMARY KEY (id),
	FOREIGN KEY (domain_uid) REFERENCES contact_domain(uid) ON DELETE CASCADE ON UPDATE CASCADE,
	INDEX index_domain (domain_uid)
...
CREATE TABLE contact (
    ...
    uid CHAR(32) NOT NULL COMMENT 'contact uid (this is unique for a given contact for life)',
	rid INT UNSIGNED NOT NULL COMMENT 'contact revision id',
	latest_rev BOOLEAN NOT NULL DEFAULT 1 COMMENT 'is this record the latest revision',

	domain_uid  CHAR(32) NOT NULL COMMENT 'which organization/domain owns this contact',
	...
	FOREIGN KEY (domain_uid) REFERENCES contact_domain(uid) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (created_by) REFERENCES contact(uid),
	INDEX contact_domain (domain_uid),
    INDEX index_uidrid   (uid, rid),
...
ALTER TABLE contact_domain ADD FOREIGN KEY (created_by) REFERENCES contact(uid);
...
CREATE TABLE contact_individual(
    ...
    -- contact_uid+rid = contact.uid+contact.rid gets a revision row for a contact with type=individual
    -- revision to contact_individual values forces revisioning of parent contact record
	contact_uid CHAR(32) NOT NULL COMMENT 'contact uid FK',
	...
	FOREIGN KEY (contact_uid, contact_rid) REFERENCES contact(uid, rid) ON DELETE CASCADE ON UPDATE CASCADE,
	INDEX index_uidrid (contact_uid, contact_rid)
...
CREATE TABLE contact_organization(
    ...
    -- contact_uid+rid = contact.uid+contact.rid gets a revision row for a contact with type=organizaton
    -- revision to contact_individual values forces revisioning of parent contact record
	contact_uid CHAR(32) NOT NULL COMMENT 'contact uid FK',
	contact_rid INT UNSIGNED NOT NULL COMMENT 'contact revision id FK',
	...
	sic_code VARCHAR(64),
	primary_contact_uid CHAR(32) COMMENT 'optional FK to primary contact for this org',

	PRIMARY KEY (id),
	INDEX index_uidrid (contact_uid, contact_rid),

	FOREIGN KEY (contact_uid, contact_rid) REFERENCES contact(uid, rid) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (primary_contact_uid) REFERENCES contact(uid)
...
CREATE TABLE contact_household(
    ...
    -- contact_uid+rid = contact.id+contact.rid gets a revision row for a contact with type=household
	...
	primary_contact_uid CHAR(32) COMMENT 'optional FK to primary contact for this household',
...
CREATE TABLE contact_address(
    ...
    uid CHAR(32) NOT NULL COMMENT 'unique address id',    
	rid INT UNSIGNED NOT NULL COMMENT 'contact_address revision id',
	latest_rev BOOLEAN NOT NULL DEFAULT 1 COMMENT 'is this record the latest revision',

	domain_uid  CHAR(32) NOT NULL COMMENT 'which organization/domain owns this contact_address',
...
CREATE TABLE contact_contact_address(
	...
	contact_uid CHAR(32) NOT NULL COMMENT 'contact uid',
	address_uid CHAR(32) NOT NULL COMMENT 'contact_address id',
	...
	FOREIGN KEY (contact_uid) REFERENCES contact(uid) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (address_uid) REFERENCES contact_address(uid) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (created_by) REFERENCES contact(uid),
...
CREATE TABLE contact_email(
    ...
    uid CHAR(32) NOT NULL COMMENT 'unique id',    
	rid INT UNSIGNED NOT NULL COMMENT 'revision id',
	latest_rev BOOLEAN NOT NULL DEFAULT 1 COMMENT 'is this record the latest revision',
	...
	PRIMARY KEY(id),
    INDEX index_uidrid (uid, rid),
	INDEX index_contact (contact_uid),
...
CREATE TABLE contact_phone(
	...
	INDEX phone_contact (contact_uid)
...
CREATE TABLE contact_relationship_types(
	...
	domain_uid CHAR(32) NOT NULL COMMENT 'which organization/domain owns this type',
...
CREATE TABLE contact_relationship(
	...
	contact_uid CHAR(32) NOT NULL COMMENT 'contact uid',
	target_contact_uid CHAR(32) NOT NULL COMMENT 'target contact uid',
    ...
    INDEX index_uidrid (uid, rid),
    INDEX index_contact(contact_uid),
    INDEX index_target (target_contact_uid),

	FOREIGN KEY(relationship_type_id) REFERENCES contact_relationship_types(id) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY(contact_uid) REFERENCES contact(uid) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY(target_contact_uid) REFERENCES contact(uid) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (created_by) REFERENCES contact(uid)
...
CREATE TABLE contact_task(
	...
	target_contact_uid CHAR(32) NOT NULL COMMENT 'target contact uid for task',
	assigned_contact_uid CHAR(32) NOT NULL COMMENT 'task assigned to which contact',
	...
	PRIMARY KEY(id),
    INDEX index_uidrid (uid, rid),
	INDEX index_contact(assigned_contact_uid,target_contact_uid),
    
	FOREIGN KEY(target_contact_uid) REFERENCES contact(uid) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY(assigned_contact_uid) REFERENCES contact(uid) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (created_by) REFERENCES contact(uid)
...
CREATE TABLE contact_note(
	...
	contact_uid CHAR(32) NOT NULL COMMENT 'note is about this contact',
...
-- FOREIGN KEY(ext_property_id) REFERENCES contact_ext_property(id),
	INDEX ext_data_contact (contact_uid)
