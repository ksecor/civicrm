...
CREATE TABLE crm_contact (
	...
	PRIMARY KEY (id),
	FOREIGN KEY (domain_id) REFERENCES crm_domain(id) ON DELETE CASCADE,
	FOREIGN KEY (created_by) REFERENCES crm_contact(uuid),
...
CREATE TABLE crm_contact_individual(
	...
	-- core demographics fields (1st draft)
	gender ENUM('female','male','transgender'),
	birth_date DATE,
	race VARCHAR(255) COMMENT 'may need customizable/localized table for this ?',
	marital_status ENUM('single','married','domestic partner','divorced','widowed'),
	...
	FOREIGN KEY (contact_uuid, contact_rid) REFERENCES crm_contact(uuid, rid) ON DELETE CASCADE
...
CREATE TABLE crm_contact_organization(
	...
	FOREIGN KEY (contact_uuid, contact_rid) REFERENCES crm_contact(uuid, rid) ON DELETE CASCADE,
	FOREIGN KEY (primary_contact_uuid) REFERENCES crm_contact(uuid)
...
*
* crm_address
* Physical locations (associated with a contact and a
...
CREATE TABLE crm_address(
	...
	is_primary BOOLEAN NOT NULL DEFAULT 0 COMMENT 'primary mailing address for this contact (app allows 1 primary crm_address per contact)',
...
CREATE TABLE crm_email(
	...
	FOREIGN KEY(contact_uuid) REFERENCES crm_contact(uuid) ON DELETE CASCADE,
	FOREIGN KEY (created_by) REFERENCES crm_contact(uuid),
...
/*******************************************************
*
* crm_phone_mobile_providers
*
*******************************************************/
DROP TABLE IF EXISTS crm_phone_mobile_providers;
CREATE TABLE crm_phone_mobile_providers (
...
CREATE TABLE crm_phone(
	...
	FOREIGN KEY (created_by) REFERENCES crm_contact(uuid),
	FOREIGN KEY (context_id) REFERENCES crm_context(id),
	FOREIGN KEY (mobile_phone_provider_id) REFERENCES crm_phone_mobile_providers(id)
...
*
*******************************************************/
DROP TABLE IF EXISTS crm_instant_message;
CREATE TABLE crm_instant_message(
...
* 
*******************************************************/
DROP TABLE IF EXISTS crm_relationship_types;
...
CREATE TABLE crm_relationship(
	...
	FOREIGN KEY(relationship_type_id) REFERENCES crm_relationship_types(id) ON DELETE CASCADE,
	FOREIGN KEY(contact_uuid) REFERENCES crm_contact(uuid) ON DELETE CASCADE,
	FOREIGN KEY(target_contact_uuid) REFERENCES crm_contact(uuid) ON DELETE CASCADE,
	FOREIGN KEY (created_by) REFERENCES crm_contact(uuid)
...
CREATE TABLE crm_task(
	...
	FOREIGN KEY(target_contact_uuid) REFERENCES crm_contact(uuid) ON DELETE CASCADE,
	FOREIGN KEY(assigned_contact_uuid) REFERENCES crm_contact(uuid) ON DELETE CASCADE,
	FOREIGN KEY (created_by) REFERENCES crm_contact(uuid)
...
* crm_role_type
* 
* Role_types are defined sets relationships between a
* contact and the organization owning the database (e.g.
* a domain). They may or may not be bound by time.
*
*******************************************************/
DROP TABLE IF EXISTS crm_role_type;
CREATE TABLE crm_role_type (
	...
	name        VARCHAR(255) COMMENT 'role name (typically brief)',
	description VARCHAR(255) COMMENT 'role description (verbose)',
	time_bound	BOOLEAN NOT NULL DEFAULT 0 COMMENT 'does this role use start/end dates?',
...
CREATE TABLE crm_role(
	...
	contact_uuid INT UNSIGNED NOT NULL COMMENT 'contact uuid',
	role_type_id INT UNSIGNED COMMENT 'fk to crm_role_type (e.g. Member, Prospect...)',

	start_date DATE COMMENT 'for time-bound role types',
	end_date DATE COMMENT 'for time-bound role types',
	...
	FOREIGN KEY(contact_uuid) REFERENCES crm_contact(uuid) ON DELETE CASCADE,
	FOREIGN KEY (created_by) REFERENCES crm_contact(uuid),
	FOREIGN KEY (role_type_id) REFERENCES crm_role_type(id)
