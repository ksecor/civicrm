...
*
* Rev 11/17/2004:
*   Switch to UUID (universal unique identifier) as 'handle'
*    for each object instance. Combine with RID (revision id) to retrieve
*    a specific revision of an object instance.
...
*	Added created_by (uuid) to all user-editable tables
...
CREATE TABLE contact_domain (
    ...
    uuid CHAR(32) NOT NULL COMMENT 'domain id',
...
CREATE TABLE contact (
    ...
    uuid CHAR(32) NOT NULL COMMENT 'contact uuid (this is unique for a given contact for life)',
...
CREATE TABLE contact_individual(
	...
	contact_uuid CHAR(32) NOT NULL COMMENT 'contact uuid FK',
...
CREATE TABLE contact_organization(
	...
	sic_code VARCHAR(64),
	primary_contact_uuid CHAR(32) COMMENT 'optional FK to primary contact for this org',
...
CREATE TABLE contact_household(
	...
	primary_contact_uuid CHAR(32) COMMENT 'optional FK to primary contact for this household',
...
CREATE TABLE contact_address(
    ...
    uuid CHAR(32) NOT NULL COMMENT 'unique address id',    
...
CREATE TABLE contact_contact_address(
	...
	contact_uuid CHAR(32) NOT NULL COMMENT 'contact uuid',
	address_uuid CHAR(32) NOT NULL COMMENT 'contact_address id',
...
CREATE TABLE contact_email(
    ...
    uuid CHAR(32) NOT NULL COMMENT 'unique id',    
	rid INT UNSIGNED NOT NULL COMMENT 'revision id',
	latest_rev BOOLEAN NOT NULL DEFAULT 1 COMMENT 'is this record the latest revision',
...
CREATE TABLE contact_relationship_types(
	...
	domain_uuid CHAR(32) NOT NULL COMMENT 'which organization/domain owns this type',
...
CREATE TABLE contact_relationship(
	...
	contact_uuid CHAR(32) NOT NULL COMMENT 'contact uuid',
	target_contact_uuid CHAR(32) NOT NULL COMMENT 'target contact uuid',
...
CREATE TABLE contact_task(
	...
	target_contact_uuid CHAR(32) NOT NULL COMMENT 'target contact uuid for task',
	assigned_contact_uuid CHAR(32) NOT NULL COMMENT 'task assigned to which contact',
...
CREATE TABLE contact_note(
	...
	contact_uuid CHAR(32) NOT NULL COMMENT 'note is about this contact',
...
/*******************************************************
*
* extended property tables
*	contact_ext_property : defines each custom property and it's data type
*		? should validation 'types' be keyed to this table or the form_field table below ?
*		? can these properties extend other objects (tables) besides 'contact' ?
*   contact_ext_data : stores the data
*
* form-rendering tables
*	contact_form_field : HTML form_field attributes, linked to a contact_ext_property
*	contact_form_group : a group contains one or more related form_fields
*	contact_form_component : may be form_fields, form_groups, or other forms. Rows are
*		indexed to a specific contact_form.
*	contact_form : defines form title, prefix text, etc. Points to a set of form_component
*     rows
*   contact_form_option (option values and labels for any form element which needs them) 
*
*******************************************************/
...
CREATE TABLE contact_ext_property(
	...
	domain_uuid  CHAR(32) NOT NULL COMMENT 'which organization/domain owns this ext property',

	name        VARCHAR(255) COMMENT 'variable name/programmatic handle for this property',
    description VARCHAR(255) COMMENT 'property description (a more verbose description)',
...
CREATE TABLE contact_ext_data(
	...
	contact_uuid CHAR(32) NOT NULL COMMENT 'data is for this contact uuid',
