...
/* Include the Zend_Birt_Report_Design object according to the PHP version
...
if (substr(PHP_VERSION,0,1) == 5) {
	require_once('Reports/Zend/Birt/Design/PHP5.php');
} else {
	require_once('Reports/Zend/Birt/Design/PHP4.php');
}
