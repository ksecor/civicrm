...
- (void)applicationDidFinishLaunching:(UIApplication *)application {
	 ...
	 *
	 * TODO: this should be configurable - you don't want to waste energy booting the gps if it's not needed.
	 */
	...
	/*
	 * CiviCRM always laods the same static local file to start
	 */
	NSBundle * thisBundle = [NSBundle bundleForClass:[self class]];
	staticStartURL = [[NSURL fileURLWithPath:[thisBundle pathForResource:@"index" ofType:@"html" inDirectory:@"www"]] retain];
...
//			webView.hidden = YES;
			...
			[sound play];
		} else if ([command isEqualToString:@"loadURL"]){
			alert(command);
		}
