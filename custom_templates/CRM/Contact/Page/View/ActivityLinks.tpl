...
<div class= "section-hidden section-hidden-border">
   <a href="{crmURL p='civicrm/contact/view/activity' q="activity_id=5&amp;reset=1&amp;cid=`$contactId`&amp;selectedChild=activity&amp;action=add&subType=6"}"><img src="{$config->resourceBase}i/custom_activity.gif" alt="{ts}Front Line Action{/ts}"/></a>&nbsp;
   <a href="{crmURL p='civicrm/contact/view/activity' q="activity_id=5&amp;reset=1&amp;cid=`$contactId`&amp;selectedChild=activity&amp;action=add&subType=6"}">{ts}Front Line Action{/ts}</a>&nbsp;&nbsp;
...
{/if}
   ...
   <a href="{crmURL p='civicrm/contact/view/activity' q="activity_id=5&amp;reset=1&amp;cid=`$contactId`&amp;selectedChild=activity&amp;action=add&subType=5"}"><img src="{$config->resourceBase}i/meeting.gif" alt="{ts}Other Activity{/ts}"/></a>&nbsp;
   <a href="{crmURL p='civicrm/contact/view/activity' q="activity_id=5&amp;reset=1&amp;cid=`$contactId`&amp;selectedChild=activity&amp;action=add&subType=5"}">{ts}Other Activity{/ts}</a>&nbsp;&nbsp;
