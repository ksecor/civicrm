...
for CODE in css i js l10n packages PEAR templates joomla extern; do
  echo $CODE
...
echo "1.5.$REV Drupal PHP4" > $TRG/civicrm-version.txt


# gen tarball
cd $TRG/..
tar czf $DM_TARGETDIR/civicrm-drupal-php4-1.5-rev$REV.tgz civicrm
