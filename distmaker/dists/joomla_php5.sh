...
# final touch
REV=`svnversion -n $SRC | cut -d'M' -f1`
echo "1.5BETA.$REV Joomla PHP5" > $TRG/civicrm-version.txt
...
zip -r -9 $DM_TARGETDIR/civicrm-joomla-php5-1.5BETA-rev$REV.zip com_civicrm
