...
VALUES    
    ...
    ( @domainID, 'civicrm/report/instance/16&reset=1',    '{ts escape="sql"}Activity Report{/ts}',                    '{literal}activity{/literal}',                         'administer CiviCRM',       '',  @reportlastID,  '1', NULL, 18 ),
    ( @domainID, 'civicrm/report/instance/17&reset=1',    '{ts escape="sql"}Relationship Report{/ts}',                '{literal}Relationship Report{/literal}',              'administer CiviCRM',       '',  @reportlastID,  '1', NULL, 19 ),
    ...
    ( @domainID, 'civicrm/report/instance/20&reset=1',    '{ts escape="sql"}Top Donors Report{/ts}',                      '{literal}Top Donors Report{/literal}',                      'access CiviContribute', '',  @reportlastID,  '1', NULL, 22 ),    
    ( @domainID, 'civicrm/report/instance/21&reset=1',    '{ts escape="sql"}Pledge Summary Report{/ts}',              '{literal}Pledge Summary Report{/literal}',            'access CiviPledge',       '',  @reportlastID,  '1', NULL, 23 ),
    ( @domainID, 'civicrm/report/instance/22&reset=1',    '{ts escape="sql"}Pledged But not Paid Report{/ts}',        '{literal}Pledged But not Paid Report{/literal}',      'access CiviPledge',       '',  @reportlastID,  '1', NULL, 24 );
