...
-- they are used for display only in the prefernces field settings
  ...
  (@option_group_id_report , '{ts escape="sql"}Donation Summary Report (Repeat){/ts}',        'contribute/repeatSummary',       'CRM_Report_Form_Contribute_RepeatSummary',       NULL, 0, NULL, 8,  '{ts escape="sql"}Given two date ranges, shows contacts (and their contributions) who contributed in both the date ranges with percentage increase / decrease.{/ts}', 0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Donation Detail Report (Repeat){/ts}' ,        'contribute/repeatDetail',        'CRM_Report_Form_Contribute_RepeatDetail',        NULL, 0, NULL, 9,  '{ts escape="sql"}Allows the user to analyze repeat contributions, contributions that come from the same contact during two periods. Ex if a user wants to see contributions made by people in 2007/2008 and then changed in their contribution behaviour{/ts}', 0, 0, 0, @contributeCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Donation Summary Report (Count){/ts}',         'contribute/summaryCount',        'CRM_Report_Form_Contribute_SummaryCount',        NULL, 0, NULL, 10, '{ts escape="sql"}Displays Contribution Summary for one/all users including  the number of times they contributed, the total amount contributed and average{/ts}',  0, 0, 0, @contributeCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Donation Summary Report (Organization){/ts}', 'contribute/organizationSummary', 'CRM_Report_Form_Contribute_OrganizationSummary',  NULL, 0, NULL, 11, '{ts escape="sql"}Displays a detailed contribution report for Organization relationships with contributors, as to if contribution done was  from an employee of some organization or from that Organization itself.{/ts}', 0, 0, 0, @contributeCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Donation Summary Report (Household){/ts}',     'contribute/householdSummary',    'CRM_Report_Form_Contribute_HouseholdSummary',    NULL, 0, NULL, 12, '{ts escape="sql"}Provides a detailed report for Contributions made by contributors(Or Household itself) who are having a relationship with household (For ex a Contributor is Head of Household for some household or is a member of.){/ts}',   0, 0, 0, @contributeCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Top Donors Report{/ts}',                       'contribute/topDonor',            'CRM_Report_Form_Contribute_TopDonor',            NULL, 0, NULL, 13, '{ts escape="sql"}Provides a list of the top donors during a time period you define. You can include as many donors as you want (for example, top 100 of your donors).{/ts}',        0, 0, 0, @contributeCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}SYBUNT Report{/ts}',                           'contribute/sybunt',              'CRM_Report_Form_Contribute_Sybunt',              NULL, 0, NULL, 14, '{ts escape="sql"}(some years but unfortunately not this) Provides a list of constituents who donated at some time in the history of your organization but did not donate during the time period you specify.{/ts}', 0, 0, 1,@contributeCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}LYBUNT Report{/ts}',                           'contribute/lybunt',              'CRM_Report_Form_Contribute_Lybunt',              NULL, 0, NULL, 15, '{ts escape="sql"}(last year but unfortunately not this) Provides a list of constituents who donated last year but did not donate during the time period you specify as the current year.{/ts}', 0, 0, 1,@contributeCompId, NULL),	
  (@option_group_id_report , '{ts escape="sql"}Membership Report (Summary){/ts}',             'member/summary',                 'CRM_Report_Form_Member_Summary',                 NULL, 0, NULL, 16, '{ts escape="sql"}Provides alist of members. You can included address and phone information and group the members based on membership type.{/ts}', 0, 0, 1, @memberCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Membership Report (Detail){/ts}',              'member/detail',                  'CRM_Report_Form_Member_Detail',                  NULL, 0, NULL, 17, '{ts escape="sql"}Provides a list of member along with their membership Status and membership details Ex Join Date, start Date, End Date{/ts}', 0, 0, 1, @memberCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Membership Report (Lapsed){/ts}',              'member/lapseSummary',            'CRM_Report_Form_Member_LapseSummary',            NULL, 0, NULL, 18, '{ts escape="sql"}Provides a list of memberships that lapsed or will lapse before the date you specify.{/ts}', 0, 0, 1, @memberCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Event Participant Report (List){/ts}',         'event/participantListing',       'CRM_Report_Form_Event_ParticipantListing',       NULL, 0, NULL, 19, '{ts escape="sql"}Provides lists of sponsors or registrants for an event.{/ts}', 0, 0, 1, @eventCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Event Report (Summary){/ts}',                     'event/eventSummary',             'CRM_Report_Form_Event_EventSummary',             NULL, 0, NULL, 20, '{ts escape="sql"}Provides an overview of event finances. You can include key information, such as event ID, registration, attendance, income generated to help you determine the success of an event.{/ts}', 0, 0, 1, @eventCompId, NULL),			
  (@option_group_id_report , '{ts escape="sql"}Event Income Report (Detail){/ts}',                   'event/eventIncome',              'CRM_Report_Form_Event_EventIncome',              NULL, 0, NULL, 21, '{ts escape="sql"}Helps you to analyze the income generated by an event. The report can include the Detail Analysis for participant type, participant status, payment methods of registrants.{/ts}',        0, 0, 1, @eventCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Pledge Report{/ts}',                           'pledge/summary',                 'CRM_Report_Form_Pledge_Summary',                 NULL, 0, NULL, 22, '{ts escape="sql"}Pledge Report{/ts}', 0, 0, 0, @pledgeCompId, NULL),			
  (@option_group_id_report , '{ts escape="sql"}Pledged But not Paid Report{/ts}',             'pledge/pbnp',                    'CRM_Report_Form_Pledge_Pbnp',                    NULL, 0, NULL, 23, '{ts escape="sql"}Pledged but not Paid Report{/ts}', 0, 0, 0, @pledgeCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Soft Credit Report{/ts}',                           'contribute/softcredit',              'CRM_Report_Form_Contribute_SoftCredit',              NULL, 0, NULL, 24, '{ts escape="sql"}This Report gives detailson about Soft Credits mentioned while making a contribution by a donor.{/ts}', 0, 0, 1,@contributeCompId, NULL),
