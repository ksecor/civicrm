...
INSERT INTO civicrm_domain( name, email_name, email_address, email_domain, version, loc_block_id ) 
    VALUES ( @domain_name, 'FIXME', 'info@FIXME.ORG', 'FIXME.ORG', '2.1', @locBlockId);
