...
( 'civicrm/contact/search?reset=1', '{ts escape="sql"}Find Contacts( Basic ){/ts}', 'Find Contacts', NULL, '', '4', '1', NULL ), 
( 'civicrm/contact/search/advanced?reset=1', '{ts escape="sql"}Find Contacts( Advanced ){/ts}', 'Find Contacts( Advanced )', NULL, '', '4', '1', NULL ), 
( 'civicrm/contact/search/custom?csid=15&reset=1', '{ts escape="sql"}Full-text Search{/ts}', 'Full-text Search', NULL, '', '4', '1', NULL ), 
( 'civicrm/contact/search/builder?reset=1', '{ts escape="sql"}Search Builder{/ts}', 'Search Builder', NULL, '', '4', '1', '1' ), 
( 'civicrm/case/search?reset=1', '{ts escape="sql"}Find Cases{/ts}', 'Find Cases', 'access CiviCase', '', '4', '1', NULL ), 
( 'civicrm/contribute/search?reset=1', '{ts escape="sql"}Find Contributions{/ts}', 'Find Contributions', 'access CiviContribute', '', '4', '1', NULL ), 
...
( 'civicrm/pledge/search?reset=1', '{ts escape="sql"}FindPledges{/ts}', 'Find Pledges', '', 'access CiviPledge',  '4', '1', NULL ), 
...
( 'civicrm/contact/add?reset=1&ct=Individual', '{ts escape="sql"}New Individual{/ts}', 'New Individual', NULL, '', '18', '1', NULL ), 
( 'civicrm/contact/add?reset=1&ct=Household', '{ts escape="sql"}New Household{/ts}', 'New Household', NULL, '', '18', '1', NULL ), 
( 'civicrm/contact/add?reset=1&ct=Organization', '{ts escape="sql"}New Organization{/ts}', 'New Organization', NULL, '', '18', '1', NULL ), 
( 'civicrm/activity?reset=1&action=add&context=standalone', '{ts escape="sql"}New Activity{/ts}', 'New Activity', NULL, '', '18', '1', '1' ), 
( 'civicrm/import/contact?reset=1', '{ts escape="sql"}Import Contacts{/ts}', 'Import Contacts', NULL, '', '18', '1', NULL ), 
( 'civicrm/import/activity?reset=1', '{ts escape="sql"}Import Activities{/ts}', 'Import Activities', NULL, '', '18', '1', '1' ), 
( 'civicrm/group/add?reset=1', '{ts escape="sql"}New Group{/ts}', 'New Group', NULL, '', '18', '1', NULL ), 
( 'civicrm/group?reset=1', '{ts escape="sql"}Manage Groups{/ts}', 'Manage Groups', NULL, '', '18', '1', '1' ), 
( 'civicrm/admin/tag?reset=1&action=add', '{ts escape="sql"}New Tag{/ts}', 'New Tag', NULL, '', '18', '1', NULL ), 
( 'civicrm/admin/tag?reset=1', '{ts escape="sql"}Manage Tags( Categories ){/ts}', 'Manage Tags( Categories )', NULL, '', '18', '1', NULL ), 
( NULL, '{ts escape="sql"}Contributions{/ts}', 'Contributions', 'access CiviContribute', '', NULL, '1', NULL ), 
( 'civicrm/contribute?reset=1', '{ts escape="sql"}Dashboard{/ts}', 'CiviContributeDashboard', NULL, '', '29', '1', NULL ), 
( 'civicrm/contact/view/contribution?reset=1&action=add&context=standalone', '{ts escape="sql"}New Contribution{/ts}', 'New Contribution', NULL, '', '29', '1', NULL ), 
( 'civicrm/contribute/search?reset=1', '{ts escape="sql"}Find Contributions{/ts}', 'Find Contributions', NULL, '', '29', '1', NULL ), 
( 'civicrm/contribute/import?reset=1', '{ts escape="sql"}Import Contributions{/ts}', 'Import Contributions', NULL, '', '29', '1', '1' ), 
( 'civicrm/admin/contribute?reset=1&action=add', '{ts escape="sql"}New Contribution Page{/ts}', 'New Contribution Page', NULL, '', '29', '1', NULL ), 
( 'civicrm/admin/contribute?reset=1', '{ts escape="sql"}Manage Contribution Pages{/ts}', 'Manage Contribution Pages', NULL, '', '29', '1', '1' ), 
( 'civicrm/admin/pcp?reset=1', '{ts escape="sql"}Manage Personal CampaignPages{/ts}', 'Personal Campaign Pages', NULL, '', '29', '1', NULL ), 
( NULL, '{ts escape="sql"}Events{/ts}', 'Events', 'access CiviEvent', '', NULL, '1', NULL ), 
( 'civicrm/event?reset=1', '{ts escape="sql"}Dashboard{/ts}', 'CiviEvent Dashboard', NULL, '', '37', '1', NULL ), 
( NULL, '{ts escape="sql"}Register New Participant{/ts}', 'Register New Participant', NULL, '', '37', '1', NULL ), 
( 'civicrm/event/search?reset=1', '{ts escape="sql"}Find Participants{/ts}', 'Find Participants', NULL, '', '37', '1', NULL ), 
( 'civicrm/event/import?reset=1', '{ts escape="sql"}Import Participants{/ts}', 'Import Participants', NULL, '', '37', '1', '1' ), 
( 'civicrm/event/add?reset=1&action=add', '{ts escape="sql"}New Event{/ts}', 'New Event', NULL, '', '37', '1', NULL ), 
( 'civicrm/event/manage?reset=1', '{ts escape="sql"}Manage Events{/ts}', 'Manage Events', NULL, '', '37', '1', NULL ), 
( 'civicrm/admin/price?reset=1&action=add', '{ts escape="sql"}New Price Set{/ts}', 'New Price Set', NULL, '', '37', '1', NULL ), 
( 'civicrm/event/price?reset=1', '{ts escape="sql"}Manage Price Sets{/ts}', 'Manage Price Sets', NULL, '', '37', '1', NULL ), 
( NULL, '{ts escape="sql"}Mailings{/ts}', 'Mailings', 'access CiviMail', '', NULL, '1', NULL ), 
( 'civicrm/mailing/send?reset=1', '{ts escape="sql"}New Mailing{/ts}', 'New Mailing', NULL, '', '46', '1', NULL ), 
( 'civicrm/mailing/browse/unscheduled?reset=1&scheduled=false', '{ts escape="sql"}Draft and Unscheduled Mailings{/ts}', 'Draft and Unscheduled Mailings', NULL, '', '46', '1', NULL ), 
( 'civicrm/mailing/browse/scheduled?reset=1&scheduled=true', '{ts escape="sql"}Scheduled and Sent Mailings{/ts}', 'Scheduled and Sent Mailings', NULL, '', '46', '1', NULL ), 
( 'civicrm/mailing/browse/archived?reset=1', '{ts escape="sql"}Archived Mailings{/ts}', 'Archived Mailings', NULL, '', '46', '1', NULL ), 
( 'civicrm/admin/component?reset=1', '{ts escape="sql"}Headers, Footers, and Automated Messages{/ts}', 'Headers, Footers, and Automated Messages', NULL, '', '46', '1', NULL ), 
( NULL, '{ts escape="sql"}Memberships{/ts}', 'Memberships', 'access CiviMember', '', NULL, '1', NULL ), 
( 'civicrm/member?reset=1', '{ts escape="sql"}Dashboard{/ts}', 'Dashboard', NULL, '', '52', '1', NULL ), 
( NULL, '{ts escape="sql"}New Member{/ts}', 'New Member', NULL, '', '52', '1', NULL ), 
( 'civicrm/member/search?reset=1', '{ts escape="sql"}Find Members{/ts}', 'Find Members', NULL, '', '52', '1', NULL ), 
( 'civicrm/member/import?reset=1', '{ts escape="sql"}Import Members{/ts}', 'Import Members', NULL, '', '52', '1', NULL ), 
...
( 'civicrm/grant?reset=1', '{ts escape="sql"}New Grant{/ts}', 'New Grant', NULL, '', '58', '1', NULL ), 
( NULL, '{ts escape="sql"}Cases{/ts}', 'Cases', 'access CiviCase', '', '57', '1', NULL ), 
( 'civicrm/case?reset=1', '{ts escape="sql"}Dashboard{/ts}', 'Dashboard', NULL, '', '60', '1', NULL ), 
( NULL, '{ts escape="sql"}New Case for New Client{/ts}', 'New Case for New Client', NULL, '', '60', '1', NULL ), 
( 'civicrm/case/search?reset=1', '{ts escape="sql"}Find Cases{/ts}', 'Find Cases', NULL, '', '60', '1', NULL ), 
( NULL, '{ts escape="sql"}Administer{/ts}', 'Administer', NULL, '', NULL, '1', NULL ), 
( 'civicrm/admin?reset=1', '{ts escape="sql"}Administration Console{/ts}', 'Administration Console', NULL, '', '64', '1', NULL ), 
( NULL, '{ts escape="sql"}Customize{/ts}', 'Customize', NULL, '', '64', '1', NULL ), 
( 'civicrm/admin/custom/group?reset=1', '{ts escape="sql"}Custom Data{/ts}', 'Custom Data', NULL, '', '66', '1', NULL ), 
( 'civicrm/admin/uf/group?reset=1', '{ts escape="sql"}CiviCRM Profile{/ts}', 'CiviCRM Profile', NULL, '', '66', '1', NULL ), 
( 'civicrm/admin/options/custom_search?reset=1&group=custom_search', '{ts escape="sql"}Manage Custom Searches{/ts}', 'Manage Custom Searches', NULL, '', '66', '1', NULL ), 
( NULL, '{ts escape="sql"}Configure{/ts}', 'Configure', NULL, '', '64', '1', NULL ), 
( 'civicrm/admin/configtask?reset=1', '{ts escape="sql"}Configuration Checklist{/ts}', 'Configuration Checklist', NULL, '', '70', '1', NULL ), 
( 'civicrm/admin/setting?reset=1', '{ts escape="sql"}Global Settings{/ts}', 'Global Settings', NULL, '', '70', '1', NULL ), 
( 'civicrm/admin/deduperules?reset=1', '{ts escape="sql"}Find and Merge Duplicate Contacts{/ts}', 'Find and Merge Duplicate Contacts', '', '', '70', '1', NULL ), 
( 'civicrm/admin/mapping?reset=1', '{ts escape="sql"}Import/Export Mappings{/ts}', 'Import/Export Mappings', NULL, '', '70', '1', NULL ), 
( 'civicrm/admin/messageTemplates?reset=1', '{ts escape="sql"}Message Templates{/ts}', 'Message Templates', NULL, '', '70', '1', NULL ), 
( NULL, '{ts escape="sql"}Manage{/ts}', 'Manage', NULL, '', '64', '1', NULL ), 
( 'civicrm/admin/synchUser?reset=1', '{ts escape="sql"}Synchronize Users to Contacts{/ts}', 'Synchronize Users to Contacts', NULL, '', '76', '1', NULL ), 
( 'civicrm/admin/access?reset=1', '{ts escape="sql"}Access Control{/ts}', 'Access Control', NULL, '', '76', '1', NULL ), 
( NULL, '{ts escape="sql"}Option Lists{/ts}', 'Option Lists', NULL, '', '64', '1', NULL ), 
( 'civicrm/admin/options/activity_type?reset=1&group=activity_type', '{ts escape="sql"}Activity Types{/ts}', 'Activity Types', NULL, '', '79', '1', NULL ), 
( 'civicrm/admin/options/gender?reset=1&group=gender', '{ts escape="sql"}Gender Options{/ts}', 'Gender Options', NULL, '', '79', '1', NULL ), 
