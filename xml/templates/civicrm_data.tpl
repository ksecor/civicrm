...
( 'civicrm/contact/search?reset=1', '{ts escape="sql"}Find Contacts( Basic ){/ts}', 'Find Contacts( Basic )', NULL, '', '4', '1', NULL, 1 ), 
( 'civicrm/contact/search/advanced?reset=1', '{ts escape="sql"}Find Contacts( Advanced ){/ts}', 'Find Contacts( Advanced )', NULL, '', '4', '1', NULL, 2 ), 
...
( 'civicrm/admin/pcp?reset=1', '{ts escape="sql"}Manage Personal CampaignPages{/ts}', 'Personal Campaign Pages', NULL, '', '29', '1', NULL, 7 ), 
...
( NULL, '{ts escape="sql"}Register New Participant{/ts}', 'Register New Participant', NULL, '', '37', '1', NULL, 2 ), 
