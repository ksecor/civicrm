...
( NULL, '{ts escape="sql"}Full-textSearch{/ts}', '{ts escape="sql"}Full-textSearch{/ts}', '', NULL, '', '4', '1', NULL ), 
...
( NULL, '{ts escape="sql"}CustomSearches...{/ts}', '{ts escape="sql"}CustomSearches...{/ts}', '', NULL, '', '4', '1', NULL ), 
( 'civicrm/contact/search/custom?reset=1&amp;csid=11', '{ts escape="sql"}ContactsbyDateAdded{/ts}', '{ts escape="sql"}ContactsbyDateAdded{/ts}', '', NULL, '', '15', '1', NULL ), 
( 'civicrm/contact/search/custom?reset=1&amp;csid=6', '{ts escape="sql"}ProximitySearch{/ts}', '{ts escape="sql"}ProximitySearch{/ts}', '', NULL, '', '15', '1', NULL ), 
