...
INSERT INTO civicrm_uf_group
    (id, is_active, group_type,           title,                                      is_cms_user, is_reserved, help_post) VALUES
    (1,  1,         'Individual,Contact', '{ts escape="sql"}Name and Address{/ts}',   0,           0,           NULL),
    (2,  1,         'Individual,Contact', '{ts escape="sql"}Supporter Profile{/ts}',  2,           0,           '<p><strong>{ts escape="sql"}The information you provide will NOT be shared with any third party organisations.{/ts}</strong></p><p>{ts escape="sql"}Thank you for getting involved in our campaign!{/ts}</p>', 0);
...
INSERT INTO civicrm_uf_field
       (id, uf_group_id, field_name,       is_active, is_view, is_required, weight, visibility,                  in_selector, is_searchable, location_type_id, phone_type_id, label,                                         field_type,   help_post) VALUES
       (1,  1,           'first_name',     1,         0,       1,           1,      'Public Pages and Listings', 0,           1,             NULL,             NULL,          '{ts escape="sql"}First Name{/ts}',            'Individual', ''),
       (2,  1,           'last_name',      1,         0,       1,           2,      'Public Pages and Listings', 0,           1,             NULL,             NULL,          '{ts escape="sql"}Last Name{/ts}',             'Individual', '{ts escape="sql"}First and last name will be shared with other visitors to the site.{/ts}'),
       ...
       (6,  1,           'country',        1,         0,       0,           6,      'Public Pages and Listings', 0,           1,             1,                NULL,          '{ts escape="sql"}Country (Home){/ts}',        'Contact',    '{ts escape="sql"}Your state/province and country of residence will be shared with others so folks can find others in their community.{/ts}'),
