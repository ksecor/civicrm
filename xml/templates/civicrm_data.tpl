...
-- they are used for display only in the prefernces field settings
  ...
  (@option_group_id_report , 'Contact Summary Report',            'contact/summary',                'CRM_Report_Form_Contact_Summary',                NULL, 0, NULL, 1,  '{ts escape="sql"}This Report provide the list of address and telephone information for constituent records in your system.{/ts}',      0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Contact Detail Report',             'contact/detail',                 'CRM_Report_Form_Contact_Detail',                 NULL, 0, NULL, 2,  '{ts escape="sql"}This Report provide the Contact related information of Contribution, Membership, Participant, Activity{/ts}',      0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Contribution Summary Report',       'contribute/summary',             'CRM_Report_Form_Contribute_Summary',             NULL, 0, NULL, 3,  '{ts escape="sql"}Shows contribution / amount statistics by month / week / year .. country / state .. type.{/ts}', 0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , 'Contribute Detail Report',          'contribute/detail',              'CRM_Report_Form_Contribute_Detail',              NULL, 0, NULL, 4,  '{ts escape="sql"}Lists detailed contribution(s) for one / all contacts .. Contribution summary report points to this report for specific details.{/ts}', 0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , 'Repeat Contribution Summary',       'contribute/repeatSummary',       'CRM_Report_Form_Contribute_RepeatSummary',       NULL, 0, NULL, 5,  '{ts escape="sql"}Given two date ranges, shows contacts (and their contributions) who contributed in both the date ranges with percentage increase / decrease.{/ts}', 0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , 'Repeat Contribution Detail' ,       'contribute/repeatDetail',        'CRM_Report_Form_Contribute_RepeatDetail',        NULL, 0, NULL, 6,  '{ts escape="sql"}Contribution Repeat Details{/ts}', 0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , 'Contribution Summary Count',        'contribute/summaryCount',        'CRM_Report_Form_Contribute_SummaryCount',        NULL, 0, NULL, 7,  '{ts escape="sql"}Contribution Summary Count{/ts}',  0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , 'Activity Report',                   'activity',                       'CRM_Report_Form_Activity',                       NULL, 0, NULL, 8,  '{ts escape="sql"}Activity Search{/ts}', 0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Walklist',                          'walklist',                       'CRM_Report_Form_Walklist',                       NULL, 0, NULL, 9,  '{ts escape="sql"}Walk List{/ts}',       0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Membership Summary Report',         'member/summary',                 'CRM_Report_Form_Member_Summary',                 NULL, 0, NULL, 10, '{ts escape="sql"}This Report provide the list of members. You can included address and phone information and group the members based on membership type.{/ts}', 0, 0, 1, @memberCompId, NULL),
  (@option_group_id_report , 'Member Detail Report',              'member/detail',                  'CRM_Report_Form_Member_Detail',                  NULL, 0, NULL, 11, '{ts escape="sql"}Membership Details{/ts}', 0, 0, 1, @memberCompId, NULL),
  (@option_group_id_report , 'Event Participant Listing',         'event/participantListing',       'CRM_Report_Form_Event_ParticipantListing',       NULL, 0, NULL, 12, '{ts escape="sql"}This Report provides lists of sponsors or registrants for an event.{/ts}', 0, 0, 1, @eventCompId, NULL),
  (@option_group_id_report , 'Event Income Report',               'event/eventIncome',              'CRM_Report_Form_Event_EventIncome',              NULL, 0, NULL, 13, '{ts escape="sql"}This Report helps you to analyze the income generated by an event. The report can include the Detail Analysis for participant type, participant status, payment methods of registrants.{/ts}',        0, 0, 1, @eventCompId, NULL),
  (@option_group_id_report , 'Organization Contribution Summary', 'contribute/organizationSummary', 'CRM_Report_Form_Contribute_OrganizationSummary', NULL, 0, NULL, 14, '{ts escape="sql"}Orgnization Contribution Summary{/ts}', 0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , 'Household Contribution Summary',    'contribute/householdSummary',    'CRM_Report_Form_Contribute_HouseholdSummary',    NULL, 0, NULL, 15, '{ts escape="sql"}Household Contribution Summary{/ts}',   0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , 'Contribution TopDonor Report',      'contribute/topDonor',            'CRM_Report_Form_Contribute_TopDonor',            NULL, 0, NULL, 16, '{ts escape="sql"}This Report provides a list of the top donors during a time period you define. You can include as many donors as you want (for example, top 100 of your donors).{/ts}',        0, 0, 1, @contributeCompId, NULL),
  ...
  (@option_group_id_report , 'Membership Lapse Summary Report',   'member/lapseSummary',            'CRM_Report_Form_Member_LapseSummary',            NULL, 0, NULL, 18, '{ts escape="sql"}This Reportp provides a list of memberships that lapsed or will lapse before the date you specify.{/ts}', 0, 0, 1, @memberCompId, NULL),
  (@option_group_id_report , 'SYBUNT',                            'contribute/sybunt',              'CRM_Report_Form_Contribute_Sybunt',              NULL, 0, NULL, 19, '{ts escape="sql"}This Report (some years but unfortunately not this) provides a list of constituents who donated at some time in the history of your organization but did not donate during the time period you specify.{/ts}', 0, 0, 1,@contributeCompId, NULL),
  (@option_group_id_report , 'LYBUNT',                            'contribute/lybunt',              'CRM_Report_Form_Contribute_Lybunt',              NULL, 0, NULL, 20, '{ts escape="sql"}This Report (last year but unfortunately not this) provides a list of constituents who donated last year but did not donate during the time period you specify as the current year.{/ts}', 0, 0, 1,@contributeCompId, NULL),	
  (@option_group_id_report , 'Event Summary Report',              'event/eventSummary',             'CRM_Report_Form_Event_EventSummary',             NULL, 0, NULL, 21, '{ts escape="sql"}This Report provides an overview of event finances. You can include key information, such as event ID, registration, attendance, income generated to help you determine the success of an event.{/ts}', 0, 0, 1, @eventCompId, NULL),			
