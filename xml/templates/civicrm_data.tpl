...
-- they are used for display only in the prefernces field settings
  ...
  (@option_group_id_csearch , 'CRM_Contact_Form_Search_Custom_ContribSYBNT', 11, 'CRM_Contact_Form_Search_Custom_ContribSYBNT', NULL, 0, NULL, 11, '{ts escape="sql"}Contributions made in Year X and not Year Y{/ts}', 0, 0, 1, NULL, NULL),
