...
INSERT INTO civicrm_participant_status_type
  ...
  ( '',                                                                  			    '{ts escape="sql"}Our Favorites{/ts}',     		   '{ts escape="sql"}Our Favorites{/ts}' , 	    ''  ,                                      '' ,                   '' ,                               NULL,            '1'      ),
  ( '',                                                                    			    '{ts escape="sql"}CiviCRM Blog{/ts}',     		   '{ts escape="sql"}CiviCRM Blog{/ts}' ,   	 'http://civicrm.org/blog' ,    '' ,                    '' ,                               '1',            '1'             ),
  ( 'civicrm/profile/create?gid=1&amp;reset=1',			   '{ts escape="sql"}Custom Profile{/ts}',    		   '{ts escape="sql"}Custom Profile{/ts}' , 		''  ,                                '' ,                     '' ,                               '1',            '1'           ),
  ( '',                                                                     			   '{ts escape="sql"}Search...{/ts}',              		   '{ts escape="sql"}Search...{/ts}' ,     			''  ,                                '' ,                   '' ,                               NULL,            '1'         ),
  ( '',                                                                     		   	   '{ts escape="sql"}Find Contacts (Basic){/ts}',       '{ts escape="sql"}Find Contacts{/ts}' , 		   '' , 				   '' ,                    '' ,                               '4',            '1'             ),
  ( 'civicrm/contact/search/custom?reset=1&amp;csid=15',    '{ts escape="sql"}Find Contacts (Advanced){/ts}',  '{ts escape="sql"}Advanced Search{/ts}' ,  	  '' ,  				  '' ,                    '' ,                               '4',            '1'             ),
  ( '',                                                                      			  '{ts escape="sql"}Full-text Search{/ts}',     		    '{ts escape="sql"}Full-text Search{/ts}' ,  		  '' ,   			 '' ,                    '' ,                               '4',            '1'             ),
  ( '',                                                                      			  '{ts escape="sql"}Search Builder{/ts}',     		     '{ts escape="sql"}Search Builder{/ts}' ,  		  '' ,    			'' ,                    '' ,                               '4',            '1'             ),
  ( '',                                                                 				  '{ts escape="sql"}Find Cases{/ts}',     			    '{ts escape="sql"}Find Cases{/ts}' , 			   '' ,    			'' ,                    '' ,                               '4',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Find Contributions{/ts}',     	     '{ts escape="sql"}Find Contributions{/ts}' , 	   '' , 				 '' ,                    '' ,                               '4',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Find Mailings{/ts}',   		     '{ts escape="sql"}Find Mailings{/ts}' ,  		  '' ,  				 '' ,                    '' ,                               '4',            '1'             ),
  ( '',                                                                      			  '{ts escape="sql"}Find Members{/ts}',   		     '{ts escape="sql"}Find Members{/ts}' ,  		  '' ,   			 '' ,                    '' ,                               '4',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Find Participants{/ts}',    		     '{ts escape="sql"}Find Participants{/ts}' ,  	  '' ,   			 '' ,                    '' ,                               '4',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Find Pledges{/ts}',   		    '{ts escape="sql"}Find Pledges{/ts}' ,   		  '' ,   			 '' ,                    '' ,                               '4',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Custom Searches...{/ts}',           '{ts escape="sql"}Custom Searches...{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '4',            '1'             ),
  ...
  ( '',                                                                     			  '{ts escape="sql"}Contacts{/ts}',           		   '{ts escape="sql"}Contacts{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               NULL,            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Individual{/ts}',        	   '{ts escape="sql"}New Individual{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '18',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Household{/ts}',     	           '{ts escape="sql"}New Household{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '18',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Organization{/ts}',       	   '{ts escape="sql"}New Organization{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '18',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Activity{/ts}',          		  '{ts escape="sql"}New Activity{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '18',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Import Contacts{/ts}',                '{ts escape="sql"}Import Contacts{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '18',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Import Activities{/ts}',                '{ts escape="sql"}Import Activities{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '18',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Group{/ts}',                        '{ts escape="sql"}New Group{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '18',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Manage Groups{/ts}',                 '{ts escape="sql"}Manage Groups{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '18',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Tag{/ts}',          		   '{ts escape="sql"}New Tag{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '18',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Manage Tags (Categories){/ts}',  '{ts escape="sql"}Manage Tags (Categories){/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '18',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Contributions{/ts}',          	     '{ts escape="sql"}Contributions{/ts}' ,   	  '' ,   			 'CiviContribute' ,                    '' ,                               NULL,            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Dashboard{/ts}',                         '{ts escape="sql"}CiviContribute Dashboard{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '29',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Contribution{/ts}',                '{ts escape="sql"}New Contribution{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '29',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Find Contributions{/ts}',               '{ts escape="sql"}Find Contributions{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '29',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Import Contributions{/ts}',           '{ts escape="sql"}Import Contributions{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '29',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Contribution Page{/ts}',           '{ts escape="sql"}New Contribution Page{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '29',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Manage Contribution Pages{/ts}',           '{ts escape="sql"}Manage Contribution Pages{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '29',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Manage Personal Campaign Pages{/ts}',           '{ts escape="sql"}Personal Campaign Pages{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '29',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Events{/ts}',           '{ts escape="sql"}Events{/ts}' ,   	  '' ,   			 'CiviEvent' ,                    '' ,                               NULL,            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Dashboard{/ts}',           '{ts escape="sql"}CiviEvent Dashboard{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '37',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Register New Participant{/ts}',           '{ts escape="sql"}Register New Participant{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '37',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Find Participants{/ts}',           '{ts escape="sql"}Find Participants{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '37',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Import Participants{/ts}',           '{ts escape="sql"}Import Participants{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '37',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Event{/ts}',           '{ts escape="sql"}New Event{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '37',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Manage Events{/ts}',           '{ts escape="sql"}Manage Events{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '37',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Price Set{/ts}',           '{ts escape="sql"}New Price Set{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '37',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Manage Price Sets{/ts}',           '{ts escape="sql"}Manage Price Sets{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '37',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Mailings{/ts}',           '{ts escape="sql"}Mailings{/ts}' ,   	  '' ,   			 'CiviMail' ,                    '' ,                               NULL,            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Mailing{/ts}',           '{ts escape="sql"}New Mailing{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '46',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Draft and Unscheduled Mailings{/ts}',           '{ts escape="sql"}Draft and Unscheduled Mailings{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '46',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Scheduled and Sent Mailings{/ts}',           '{ts escape="sql"}Scheduled and Sent Mailings{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '46',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Archived Mailings{/ts}',           '{ts escape="sql"}Archived Mailings{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '46',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Headers, Footers, and Automated Messages{/ts}',           '{ts escape="sql"}Headers, Footers, and Automated Messages{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '46',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Memberships{/ts}',           '{ts escape="sql"}Memberships{/ts}' ,   	  '' ,   			 'CiviMember' ,                    '' ,                               NULL,            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Dashboard{/ts}',           '{ts escape="sql"}CiviMember Dashboard{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '52',            '1'             ),    
  ( '',                                                                     			  '{ts escape="sql"}New Member{/ts}',           '{ts escape="sql"}New Member{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '52',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Find Members{/ts}',           '{ts escape="sql"}Find Members{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '52',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Import Members{/ts}',           '{ts escape="sql"}Import Members{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '52',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Other{/ts}',           '{ts escape="sql"}Other{/ts}' ,   	  '' ,   			 'CiviGrant,CiviCase' ,                    '' ,                               NULL,            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Grants{/ts}',           '{ts escape="sql"}Grants{/ts}' ,   	  '' ,   			 'CiviGrant' ,                    '' ,                               '57',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Grant{/ts}',           '{ts escape="sql"}New Grant{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '58',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Cases{/ts}',           '{ts escape="sql"}Cases{/ts}' ,   	  '' ,   			 'CiviCase' ,                    '' ,                               '57',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Dashboard{/ts}',           '{ts escape="sql"}CiviCase Dashboard{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '60',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}New Case for New Client{/ts}',           '{ts escape="sql"}New Case for New Client{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '60',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Find Cases{/ts}',           '{ts escape="sql"}Find Cases{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '60',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Administer{/ts}',           '{ts escape="sql"}Administer{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               NULL,            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Administration Console{/ts}',           '{ts escape="sql"}Administer CiviCRM{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '64',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Customize{/ts}',           '{ts escape="sql"}Customize{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '64',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Custom Data{/ts}',           '{ts escape="sql"}Custom Data{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '66',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}CiviCRM Profile{/ts}',           '{ts escape="sql"}CiviCRM Profile{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '66',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Manage Custom Searches{/ts}',           '{ts escape="sql"}Manage Custom Searches{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '68',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Configure{/ts}',           '{ts escape="sql"}Configure{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '66',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Configuration Checklist{/ts}',           '{ts escape="sql"}Configuration Checklist{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '70',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Global Settings{/ts}',           '{ts escape="sql"}Global Settings{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '70',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Find and Merge Duplicate Contacts{/ts}',           '{ts escape="sql"}Find and Merge Duplicate Contacts{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '72',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Import/Export Mappings{/ts}',           '{ts escape="sql"}Import/Export Mappings{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '72',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Message Templates{/ts}',           '{ts escape="sql"}Message Templates{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '66',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Manage{/ts}',           '{ts escape="sql"}Manage{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '64',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Synchronize Users to Contacts{/ts}',           '{ts escape="sql"}Synchronize Users to Contacts{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '76',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Access Control{/ts}',           '{ts escape="sql"}Access Control{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '76',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Option Lists{/ts}',           '{ts escape="sql"}Option Lists{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '66',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Activity Types{/ts}',           '{ts escape="sql"}Activity Types{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '66',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Gender Options{/ts}',           '{ts escape="sql"}Gender Options{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               '66',            '1'             );
  ( '',                                                                     			  '{ts escape="sql"}Help{/ts}',           '{ts escape="sql"}Help{/ts}' ,   	  '' ,   			 '' ,                    '' ,                               NULL,            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Documentation{/ts}',           '{ts escape="sql"}Documentation{/ts}' ,   	  'http://documentation.civicrm.org' ,   			 '' ,                    '' ,                               '83',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Forums{/ts}',           '{ts escape="sql"}Forums{/ts}' ,   	  'http://forum.civicrm.org' ,   			 '' ,                    '' ,                               '83',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}Participate{/ts}',           '{ts escape="sql"}Participate{/ts}' ,   	  'http://civicrm.org/participate' ,   			 '' ,                    '' ,                               '83',            '1'             ),
  ( '',                                                                     			  '{ts escape="sql"}About{/ts}',           '{ts escape="sql"}About{/ts}' ,   	  'http://civicrm.org/aboutcivicrm' ,   			 '' ,                    '' ,                               '83',            '1'             );