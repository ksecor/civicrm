...
-- they are used for display only in the prefernces field settings
  ...
  (@option_group_id_report , 'Contribution Summary Report',       'contribute/summary',             'CRM_Report_Form_Contribute_Summary',             NULL, 0, NULL, 3,  '{ts escape="sql"}Contribution Summary{/ts}', 0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , 'Contribute Detail Report',          'contribute/detail',              'CRM_Report_Form_Contribute_Detail',              NULL, 0, NULL, 4,  '{ts escape="sql"}Contribution Details{/ts}', 0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , 'Repeat Contribution Summary',       'contribute/repeatSummary',       'CRM_Report_Form_Contribute_RepeatSummary',       NULL, 0, NULL, 5,  '{ts escape="sql"}Contribution Repeat Summary{/ts}', 0, 0, 1, @contributeCompId, NULL),
  ...
  (@option_group_id_report , 'Membership Summary Report',         'membership/summary',             'CRM_Report_Form_Membership_Summary',             NULL, 0, NULL, 10, '{ts escape="sql"}Membership Summary{/ts}', 0, 0, 1, @memberCompId, NULL),
