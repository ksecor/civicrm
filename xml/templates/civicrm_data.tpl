...
-- report templates
  ...
  (@option_group_id_report , '{ts escape="sql"}Membership Report (Summary){/ts}',             'member/summary',                 'CRM_Report_Form_Member_Summary',                 NULL, 0, NULL, 15, '{ts escape="sql"}Provides a list of members. You can included address and phone information and group the members based on membership type.{/ts}', 0, 0, 1, @memberCompId, NULL),
