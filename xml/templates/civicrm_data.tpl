...
( NULL,								'{ts escape="sql"}Our Favorites{/ts}', 	'{ts escape="sql"}Our Favorites{/ts}' , '', 			'' , 		'' ,			NULL,	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}CiviCRM Blog{/ts}', 	'{ts escape="sql"}CiviCRM Blog{/ts}' , 'http://civicrm.org/blog', NULL, 	'AND', 			'1', 	'1',		NULL ),
( 'civicrm/profile/create?gid=1&amp;reset=1', 			'{ts escape="sql"}Custom Profile{/ts}',	'{ts escape="sql"}Custom Profile{/ts}',	'',			'',		'',			'1',	'1',		NULL ),
( NULL,								'{ts escape="sql"}Search...{/ts}', 	'{ts escape="sql"}Search...{/ts}' ,	'', 			'',		'',			NULL,	'1',		NULL ),
( 'civicrm/contact/search',					'{ts escape="sql"}Find Contacts (Basic){/ts}','{ts escape="sql"}Find Contacts{/ts}','',			'',		'',			'4', 	'1',		NULL ),
( 'civicrm/contact/search/advanced',				'{ts escape="sql"}Find Contacts (Advanced){/ts}','{ts escape="sql"}Advanced Search{/ts}','',		'',		'',			'4',	'1',		NULL ),
( NULL,								'{ts escape="sql"}Full-text Search{/ts}','{ts escape="sql"}Full-text Search{/ts}','',			'',		'',			'4',	'1',		NULL ),
( 'civicrm/contact/search/builder',				'{ts escape="sql"}Search Builder{/ts}',	'{ts escape="sql"}Search Builder{/ts}',	'' , 			'' ,		'' , 			'4',	'1' ,		'1' ),
( 'civicrm/case/search', 					'{ts escape="sql"}Find Cases{/ts}', 	'{ts escape="sql"}Find Cases{/ts}' , 	'' , 			'access CiviCase' ,'' ,			'4',	'1' ,		NULL ),
( 'civicrm/contribute/search',					'{ts escape="sql"}Find Contributions{/ts}','{ts escape="sql"}Find Contributions{/ts}' , '' ,  		'access CiviContribute','' ,		'4',	'1' ,		NULL ),
( 'civicrm/mailing', 						'{ts escape="sql"}Find Mailings{/ts}',	'{ts escape="sql"}Find Mailings{/ts}',	'' , 			'access CiviMail','',			'4',	'1' ,		NULL ),
( 'civicrm/member/search',					'{ts escape="sql"}Find Members{/ts}',	'{ts escape="sql"}Find Members{/ts}',	'' , 			'access CiviMember','' ,		'4',	'1' ,		NULL ),
( 'civicrm/event/search', 					'{ts escape="sql"}Find Participants{/ts}', '{ts escape="sql"}Find Participants{/ts}' ,'' , 		'access CiviEvent' ,'' ,		'4',	'1' ,		NULL ),
( 'civicrm/pledge/search',					'{ts escape="sql"}Find Pledges{/ts}', 	'{ts escape="sql"}Find Pledges{/ts}' ,	'' , 			'access CiviPledge','' ,		'4',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Custom Searches...{/ts}','{ts escape="sql"}Custom Searches...{/ts}' ,'' , 		'' ,		'' , 			'4',	'1' ,		NULL ),
( 'civicrm/contact/search/custom?reset=1&amp;csid=11', 		'{ts escape="sql"}Contacts by Date Added{/ts}', '{ts escape="sql"}Contacts by Date Added{/ts}' , '' , 	'' , 		'' , 			'15',	'1' ,		NULL ),
( 'civicrm/contact/search/custom?reset=1&amp;csid=6',		'{ts escape="sql"}Proximity Search{/ts}','{ts escape="sql"}Proximity Search{/ts}' , '' , 		'' ,		'' , 			'15',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Contacts{/ts}',	'{ts escape="sql"}Contacts{/ts}' ,	'', 			'' ,		'' , 			NULL,	'1' ,		NULL ),
( 'civicrm/contact/add&amp;ct=Individual', 			'{ts escape="sql"}New Individual{/ts}',	'{ts escape="sql"}New Individual{/ts}',	'' , 			'' ,		'' , 			'18',	'1' ,		NULL ),
( 'civicrm/contact/add&amp;ct=Household',			'{ts escape="sql"}New Household{/ts}',	'{ts escape="sql"}New Household{/ts}',	'' , 			'' ,		'' , 			'18',	'1' ,		NULL ),
( 'civicrm/contact/add&amp;ct=Organization',			'{ts escape="sql"}New Organization{/ts}','{ts escape="sql"}New Organization{/ts}' ,'' , 		'' ,		'' ,			'18',	'1' ,		NULL ),
( 'civicrm/activity&amp;action=add&amp;context=standalone', 	'{ts escape="sql"}New Activity{/ts}', 	'{ts escape="sql"}New Activity{/ts}' ,	'' , 			'' ,		'' , 			'18',	'1' ,		'1' ),
( 'civicrm/import/contact',					'{ts escape="sql"}Import Contacts{/ts}','{ts escape="sql"}Import Contacts{/ts}','' , 			'' ,		'' , 			'18',	'1' ,		NULL ),
( 'civicrm/import/activity',					'{ts escape="sql"}Import Activities{/ts}','{ts escape="sql"}Import Activities{/ts}' ,'' , 		'' ,		'' , 			'18',	'1' ,		'1' ),
( 'civicrm/group/add',						'{ts escape="sql"}New Group{/ts}',	'{ts escape="sql"}New Group{/ts}' ,	'' , 			'' ,		'' , 			'18',	'1' ,		NULL ),
( 'civicrm/group',						'{ts escape="sql"}Manage Groups{/ts}',	'{ts escape="sql"}Manage Groups{/ts}' ,	'' , 			'' ,		'' , 			'18',	'1' ,		'1' ),
( 'civicrm/admin/tag&amp;action=add',				'{ts escape="sql"}New Tag{/ts}', 	'{ts escape="sql"}New Tag{/ts}' ,	'' , 			'' ,		'' , 			'18',	'1' ,		NULL ),
( 'civicrm/admin/tag', 						'{ts escape="sql"}Manage Tags (Categories){/ts}','{ts escape="sql"}Manage Tags (Categories){/ts}' ,'' , '' ,		'' , 			'18',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Contributions{/ts}', 	'{ts escape="sql"}Contributions{/ts}' ,	'' , 			'access CiviContribute' ,'' ,		NULL,	'1' ,		NULL ),
( 'civicrm/contribute', 					'{ts escape="sql"}Dashboard{/ts}', 	'{ts escape="sql"}CiviContribute Dashboard{/ts}' ,'' , 		'' ,		'' , 			'29',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}New Contribution{/ts}','{ts escape="sql"}New Contribution{/ts}' ,'' , 		'' ,		'' , 			'29',	'1' ,		NULL ),
( 'civicrm/contribute/search', 					'{ts escape="sql"}Find Contributions{/ts}','{ts escape="sql"}Find Contributions{/ts}' ,'' , 		'' ,		'' , 			'29',	'1' ,		NULL ),
( 'civicrm/contribute/import',					'{ts escape="sql"}Import Contributions{/ts}','{ts escape="sql"}Import Contributions{/ts}' ,'' , 	'' ,		'' , 			'29',	'1' ,		'1' ),
( 'civicrm/admin/contribute&amp;action=add',			'{ts escape="sql"}New Contribution Page{/ts}','{ts escape="sql"}New Contribution Page{/ts}' ,'' , 	'' ,		'' , 			'29',	'1' ,		NULL ),
( 'civicrm/admin/contribute', 					'{ts escape="sql"}Manage Contribution Pages{/ts}','{ts escape="sql"}Manage Contribution Pages{/ts}' ,'' , '' ,		'' , 			'29',	'1' ,		'1' ),
( 'civicrm/admin/pcp',						'{ts escape="sql"}Manage Personal Campaign Pages{/ts}','{ts escape="sql"}Personal Campaign Pages{/ts}' ,'' , '' ,	'' , 			'29',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Events{/ts}',		'{ts escape="sql"}Events{/ts}' ,	'' , 			'access CiviEvent' ,'' , 		NULL,	'1' ,		NULL ),
( 'civicrm/event', 						'{ts escape="sql"}Dashboard{/ts}',	'{ts escape="sql"}CiviEvent Dashboard{/ts}' ,'' , 		'' ,		'' , 			'37',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Register New Participant{/ts}','{ts escape="sql"}Register New Participant{/ts}' ,'' , '' ,		'' , 			'37',	'1' ,		NULL ),
( 'civicrm/event/search', 					'{ts escape="sql"}Find Participants{/ts}','{ts escape="sql"}Find Participants{/ts}' ,'' , 		'' ,		'' , 			'37',	'1' ,		NULL ),
( 'civicrm/event/import', 					'{ts escape="sql"}Import Participants{/ts}','{ts escape="sql"}Import Participants{/ts}' ,'' , 		'' ,		'' , 			'37',	'1' ,		'1' ),
( 'civicrm/event/add&amp;action=add',				'{ts escape="sql"}New Event{/ts}',	'{ts escape="sql"}New Event{/ts}' ,	'' , 			'' ,		'' , 			'37',	'1' ,		NULL ),
( 'civicrm/event/manage', 					'{ts escape="sql"}Manage Events{/ts}',	'{ts escape="sql"}Manage Events{/ts}' ,	'' , 			'' ,		'' , 			'37',	'1' ,		NULL ),
( 'civicrm/admin/price&amp;action=add',				'{ts escape="sql"}New Price Set{/ts}',	'{ts escape="sql"}New Price Set{/ts}' ,'' , 			'' ,		'' , 			'37',	'1' ,		NULL ),
( 'civicrm/event/price', 					'{ts escape="sql"}Manage Price Sets{/ts}','{ts escape="sql"}Manage Price Sets{/ts}' ,'' , 		'' ,		'' , 			'37',	'1',		NULL ),
( NULL,								'{ts escape="sql"}Mailings{/ts}',	'{ts escape="sql"}Mailings{/ts}' ,	'' , 			'access CiviMail' ,'' ,			 NULL,	'1' ,		NULL ),
( 'civicrm/mailing/send',					'{ts escape="sql"}New Mailing{/ts}',	'{ts escape="sql"}New Mailing{/ts}' ,	'' , 			'' ,		'' , 			'46',	'1' ,		NULL ),
( 'civicrm/mailing/browse/unscheduled&amp;scheduled=false', 	'{ts escape="sql"}Draft and Unscheduled Mailings{/ts}','{ts escape="sql"}Draft and Unscheduled Mailings{/ts}' ,'' , '' ,'' , 			'46',	'1' ,		NULL ),
( 'civicrm/mailing/browse/scheduled&amp;scheduled=true', 	'{ts escape="sql"}Scheduled and Sent Mailings{/ts}','{ts escape="sql"}Scheduled and Sent Mailings{/ts}' ,'' , '' ,	'' , 			'46',	'1' ,		NULL ),
( 'civicrm/mailing/browse/archived', 				'{ts escape="sql"}Archived Mailings{/ts}','{ts escape="sql"}Archived Mailings{/ts}' ,'' , 		'' ,		'' , 			'46',	'1' ,		NULL ),
( 'civicrm/admin/component',					'{ts escape="sql"}Headers, Footers, and Automated Messages{/ts}','{ts escape="sql"}Headers, Footers, and Automated Messages{/ts}' ,'' , '' ,'' , '46',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Memberships{/ts}',	'{ts escape="sql"}Memberships{/ts}' ,	'' , 			'access CiviMember' ,'' , 		NULL,	'1' ,		NULL ),
( 'civicrm/member', 						'{ts escape="sql"}Dashboard{/ts}',	'{ts escape="sql"}CiviMember Dashboard{/ts}' ,'' , 		'' ,		'' , 			'52',	'1' ,		NULL ), 
( NULL,								'{ts escape="sql"}New Member{/ts}',	'{ts escape="sql"}New Member{/ts}' ,'' , 			'' ,		'' , 			'52',	'1' ,		NULL ),
( 'civicrm/member/search', 					'{ts escape="sql"}Find Members{/ts}',	'{ts escape="sql"}Find Members{/ts}' ,'' , 			'' ,		'' , 			'52',	'1' ,		NULL ),
( 'civicrm/member/import', 					'{ts escape="sql"}Import Members{/ts}',	'{ts escape="sql"}Import Members{/ts}' ,'' , 			'' ,		'' , 			'52',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Other{/ts}',		'{ts escape="sql"}Other{/ts}' ,		'' , 			'access CiviGrant,access CiviCase' ,'OR', NULL,	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Grants{/ts}',		'{ts escape="sql"}Grants{/ts}' ,	'' , 			'access CiviGrant' ,'' , '		57',	'1' ,		NULL ),
( 'civicrm/grant', 						'{ts escape="sql"}New Grant{/ts}',	'{ts escape="sql"}New Grant{/ts}' ,	'' , 			'' ,		'' , 			'58',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Cases{/ts}',		'{ts escape="sql"}Cases{/ts}' ,		'' , 			'access CiviCase' ,'' , 		'57',	'1' ,		NULL ),
( 'civicrm/case',						'{ts escape="sql"}Dashboard{/ts}',	'{ts escape="sql"}CiviCase Dashboard{/ts}' ,'' , 		'' ,		'' , 			'60',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}New Case for New Client{/ts}','{ts escape="sql"}New Case for New Client{/ts}' ,'' ,	'' ,		'' , 			'60',	'1' ,		NULL ),
( 'civicrm/case/search',					'{ts escape="sql"}Find Cases{/ts}',	'{ts escape="sql"}Find Cases{/ts}' ,	'' , 			'' ,		'' , 			'60',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Administer{/ts}',	'{ts escape="sql"}Administer{/ts}' ,	'' , 			'' ,		'' , 			NULL,	'1' ,		NULL ),
( 'civicrm/admin', 						'{ts escape="sql"}Administration Console{/ts}','{ts escape="sql"}Administer CiviCRM{/ts}' ,'' , 	'' ,		'' , 			'64',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Customize{/ts}',	'{ts escape="sql"}Customize{/ts}' ,	'' , 			'' ,		'' , 			'64',	'1' ,		NULL ),
( 'civicrm/admin/custom/group',					'{ts escape="sql"}Custom Data{/ts}',	'{ts escape="sql"}Custom Data{/ts}' ,	'' , 			'' ,		'' ,			'66',	'1' ,		NULL ),
( 'civicrm/admin/uf/group',					'{ts escape="sql"}CiviCRM Profile{/ts}','{ts escape="sql"}CiviCRM Profile{/ts}','' , 			'' ,		'' , 			'66',	'1' ,		NULL ),
( 'civicrm/admin/options/custom_search&group=custom_search',	'{ts escape="sql"}Manage Custom Searches{/ts}','{ts escape="sql"}Manage Custom Searches{/ts}' ,'' , 	'' ,		'' , 			'66',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Configure{/ts}',	'{ts escape="sql"}Configure{/ts}' ,	'' , 			'' ,		'' , 			'64',	'1' ,		NULL ),
( 'civicrm/admin/configtask', 					'{ts escape="sql"}Configuration Checklist{/ts}','{ts escape="sql"}Configuration Checklist{/ts}' ,'' , 	'' ,		'' , 			'70',	'1' ,		NULL ),
( 'civicrm/admin/setting',					'{ts escape="sql"}Global Settings{/ts}','{ts escape="sql"}Global Settings{/ts}','' , 			'' ,		'' , 			'70',	'1' ,		NULL ),
( 'civicrm/admin/deduperules',					'{ts escape="sql"}Find and Merge Duplicate Contacts{/ts}','{ts escape="sql"}Find and Merge Duplicate Contacts{/ts}' ,'' , '' ,'' , 		'70',	'1' ,		NULL ),
( 'civicrm/admin/mapping',					'{ts escape="sql"}Import/Export Mappings{/ts}','{ts escape="sql"}Import/Export Mappings{/ts}' ,'' , 	'' ,		'' , 			'70',	'1' ,		NULL ),
( 'civicrm/admin/messageTemplates', 				'{ts escape="sql"}Message Templates{/ts}','{ts escape="sql"}Message Templates{/ts}' ,'' , 		'' ,		'' , 			'70',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Manage{/ts}',		'{ts escape="sql"}Manage{/ts}' ,	'' ,			'' ,		'' , 			'64',	'1' ,		NULL ),
( 'civicrm/admin/synchUser',					'{ts escape="sql"}Synchronize Users to Contacts{/ts}','{ts escape="sql"}Synchronize Users to Contacts{/ts}' ,'' , '' ,	'' , 			'76',	'1' ,		NULL ),
( 'civicrm/admin/access', 					'{ts escape="sql"}Access Control{/ts}',	'{ts escape="sql"}Access Control{/ts}',	'' , 			'' ,		'' , 			'76',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Option Lists{/ts}',	'{ts escape="sql"}Option Lists{/ts}',	'' , 			'' ,		'' , 			'64',	'1' ,		NULL ),
( 'civicrm/admin/options/activity_type&amp;group=activity_type','{ts escape="sql"}Activity Types{/ts}',	'{ts escape="sql"}Activity Types{/ts}',	'' , 			'' ,		'' , 			'79',	'1' ,		NULL ),
( 'civicrm/admin/options/gender&amp;group=gender', 		'{ts escape="sql"}Gender Options{/ts}',	'{ts escape="sql"}Gender Options{/ts}',	'' , 			'' ,		'' , 			'79',	'1' ,		NULL ),
( NULL,								'{ts escape="sql"}Help{/ts}',		'{ts escape="sql"}Help{/ts}' ,		'' , 			'' ,		'' , 			NULL,	'1' ,		NULL ),
