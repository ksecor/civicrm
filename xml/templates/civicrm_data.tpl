...
-- they are used for display only in the prefernces field settings
  ...
  (@option_group_id_report , '{ts escape="sql"}Walk / Phone List Report{/ts}',                'walklist',                       'CRM_Report_Form_Walklist',                       NULL, 0, NULL, 4,  '{ts escape="sql"}Provides a detailed report for your walk/phonelist for targetted contacts{/ts}',       0, 0, 1, NULL, NULL),
  ...
  (@option_group_id_report , '{ts escape="sql"}Donation Detail Report (Repeat){/ts}' ,        'contribute/repeatDetail',        'CRM_Report_Form_Contribute_RepeatDetail',        NULL, 0, NULL, 9,  '{ts escape="sql"}Allows the user to analyze repeat contributions, contributions that come from the same contact during two periods. Ex if a user wants to see contributions made by people in 2007/2008 and then changed in their contribution behaviour{/ts}', 0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Donation Summary Report (Count){/ts}',         'contribute/summaryCount',        'CRM_Report_Form_Contribute_SummaryCount',        NULL, 0, NULL, 10, '{ts escape="sql"}Displays Contribution Summary for one/all users including  the number of times they contributed, the total amount contributed and average{/ts}',  0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Donation Summary Report (Organization){/ts}', 'contribute/organizationSummary', 'CRM_Report_Form_Contribute_OrganizationSummary',  NULL, 0, NULL, 11, '{ts escape="sql"}Displays a detailed contribution report for Organization relationships with contributors, as to if contribution done was  from an employee of some organization or from that Organization itself.{/ts}', 0, 0, 1, @contributeCompId, NULL),
  (@option_group_id_report , '{ts escape="sql"}Donation Summary Report (Household){/ts}',     'contribute/householdSummary',    'CRM_Report_Form_Contribute_HouseholdSummary',    NULL, 0, NULL, 12, '{ts escape="sql"}Provides a detailed report for Contributions made by contributors(Or Household itself) who are having a relationship with household (For ex a Contributor is Head of Household for some household or is a member of.){/ts}',   0, 0, 1, @contributeCompId, NULL),
