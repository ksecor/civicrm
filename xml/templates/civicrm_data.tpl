...
-- they are used for display only in the prefernces field settings
  ...
  (@option_group_id_report , 'Contribution Summary Report', 'contribute/summary', 'CRM_Report_Form_Contribute_Summary'     , NULL, 0, NULL, 3, '{ts escape="sql"}Contribution Summary{/ts}', 0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Contribute Detail Report',  'contribute/detail', 'CRM_Report_Form_Contribute_Detail'       , NULL, 0, NULL, 4, '{ts escape="sql"}Contribution Details{/ts}', 0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Repeat Contribution Summary',  'contribute/repeatSummary', 'CRM_Report_Form_Contribute_RepeatSummary', NULL, 0, NULL, 5, '{ts escape="sql"}Contribution Repeat Summary{/ts}', 0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Repeat Contribution Detail' , 'contribute/repeatDetail', 'CRM_Report_Form_Contribute_RepeatDetail', NULL, 0, NULL, 6, '{ts escape="sql"}Contribution Repeat Details{/ts}', 0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Contribution Summary Count', 'contribute/summaryCount', 'CRM_Report_Form_Contribute_SummaryCount', NULL, 0, NULL, 7, '{ts escape="sql"}Contribution Summary Count{/ts}', 0, 0, 1, NULL, NULL),
  ...
  (@option_group_id_report , 'CRM_Report_Form_Walklist', 'walklist', 'CRM_Report_Form_Walklist', NULL, 0, NULL, 9, '{ts escape="sql"}Walk List{/ts}', 0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Membership Summary Report', 'membership/summary', 'CRM_Report_Form_Membership_Summary', NULL, 0, NULL, 10, '{ts escape="sql"}Membership Summary{/ts}', 0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Member Detail Report', 'member/detail', 'CRM_Report_Form_Member_Detail', NULL, 0, NULL, 10, '{ts escape="sql"}Membership Details{/ts}', 0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Event Participant Listing', 'event/participantListing', 'CRM_Report_Form_Event_ParticipantListing', NULL, 0, NULL, 12, '{ts escape="sql"}Participant Listing Details{/ts}', 0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Event Income Report', 'event/eventIncome', 'CRM_Report_Form_Event_EventIncome', NULL, 0, NULL, 13, '{ts escape="sql"}Event Income Details{/ts}', 0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Organization Contribution Summary', 'contribute/organizationSummary', 'CRM_Report_Form_Contribute_OrganizationSummary', NULL, 0, NULL, 14, '{ts escape="sql"}Orgnization Contribution Summary{/ts}', 0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Household Contribution Summary', 'contribute/household', 'CRM_Report_Form_Contribute_Household_Summary', NULL, 0, NULL, 15, '{ts escape="sql"}Household Contribution Summary{/ts}', 0, 0, 1, NULL, NULL),
  (@option_group_id_report , 'Contribution TopDonor Report', 'contribute/topDonor', 'CRM_Report_Form_Contribute_TopDonor', NULL, 0, NULL, 16, '{ts escape="sql"}Top Donor{/ts}', 0, 0, 1, NULL, NULL),
