...
VALUES
   ...
   (@option_group_id_act, '{ts escape="sql"}Event{/ts}',                              10, 'Event',  NULL, 1, NULL, 10, '{ts escape="sql"}Event{/ts}', 0, 1, 1),
...
-- they are used for display only in the prefernces field settings
  ...
  (@option_group_id_asOpt, '{ts escape="sql"}Cases{/ts}'          ,  11, NULL, NULL, 0, NULL, 11, NULL, 0, 0, 1 ),
  (@option_group_id_asOpt, '{ts escape="sql"}Case Activities{/ts}',  12, NULL, NULL, 0, NULL, 12, NULL, 0, 0, 1 ),
  (@option_group_id_asOpt, '{ts escape="sql"}Kabissa{/ts}'        ,  13, NULL, NULL, 0, NULL, 13, NULL, 0, 0, 1 ),
  (@option_group_id_asOpt, '{ts escape="sql"}Grants{/ts}'         ,  14, NULL, NULL, 0, NULL, 14, NULL, 0, 0, 1 ),
  (@option_group_id_asOpt, '{ts escape="sql"}User SQL{/ts}'       ,  15, NULL, NULL, 0, NULL, 15, NULL, 0, 0, 1 ),
...
VALUES 
 ...
 (@domain_id,'Google_Checkout','{ts}Google Checkout{/ts}',NULL,1,0,'{ts}Merchant ID{/ts}','{ts}Key{/ts}',NULL,NULL,'Payment_Google','https://checkout.google.com/',NULL,'https://checkout.google.com/buttons/checkout.gif?merchant_id=YOURMERCHANTIDHERE&w=160&h=43&style=white&variant=text&loc=en_US','https://sandbox.google.com/checkout/',NULL,'https://sandbox.google.com/checkout/buttons/checkout.gif?merchant_id=YOURMERCHANTIDHERE&w=160&h=43&style=white&variant=text&loc=en_US',4,NULL),
