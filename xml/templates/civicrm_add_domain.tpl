...
-- they are used for display only in the prefernces field settings
  ...
  (@option_group_id_csearch , 'CRM_Contact_Form_Search_Custom_PriceSet', 8, 'CRM_Contact_Form_Search_Custom_PriceSet', NULL, 0, NULL, 8, '{ts escape="sql"}Price Set Details for Event Particiant{/ts}', 0, 0, 1, NULL),
