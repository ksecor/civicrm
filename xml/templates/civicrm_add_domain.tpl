...
INSERT INTO civicrm_domain( id, name, contact_name, email_name, email_address, email_domain ) 
    VALUES ( @domain_id, @domain_name, 'Domain Contact Name', 'FIXME', 'info@FIXME.ORG', 'FIXME.ORG' );
