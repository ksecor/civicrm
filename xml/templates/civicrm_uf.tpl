...
INSERT INTO civicrm_uf_field
   ...
   VALUES
       ...
       (6, 1, 'state_province', 1, 0, 0, 6, '{ts}Your state/province and country of residence will be shared with others so folks can find others in their community.{/ts}', 'Public User Pages and Listings', 1, 1, 1, NULL, '{ts}State (Home){/ts}', 'Contact'),
       (7, 1, 'country', 1, 0, 0, 7, '', 'Public User Pages and Listings', 0, 1, 1, NULL, '{ts}Country (Home){/ts}', 'Contact'),
