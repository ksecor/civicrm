...
?>
        <label for="crm_root">CiviCRM root:</label> <input id="crm_root" type="text" name="crm_root" value="<?= $crmRoot ?>"/><br/><br/>
        <label for="base_url">Base URL of CiviCRM:</label> <input id="base_url" type="text" name="base_url" value="<?= $baseURL ?>" size="50"/><br/><br/>
        <h3>Database connection</h3>
        <h4>Local database server</h4>
        &nbsp;&nbsp;&nbsp;&nbsp;<label for="socket_file">Socket file (for local connections):</label> <input type="text" name="socket_file" size="30" value="<?= $mysqlSocket ?>"/><br/><br/>
        <h4>Remote database server</h4>
        &nbsp;&nbsp;&nbsp;&nbsp;<label for="port_number">Port:</label> <input type="text" name="port_number" size="5" value="3306"/><br/><br/>
        <label for="mysql_path">Path to mysql bin directory:</label> <input id="mysql_path" type="text" name="mysql_path" value="<?= $mysqlPath ?>" size="30"/><br/><br/>
